!(function (h, k) {
  var n,
    ...
    q = function () {
      g.addEventListener
        ? (g.removeEventListener('DOMContentLoaded', H, !1),
          h.removeEventListener('load', H, !1))
        : (g.detachEvent('onreadystatechange', H), h.detachEvent('onload', H));
    };
  function _(e) {
    var t = e.length,
      n = xe.type(e);
  ...
  (xe.fn = xe.prototype =
      ...
      init: function (e, t, n) {
        ...
        if (r[1]) {
          if (
            ...
            xe.merge(
              this,
              xe.parseHTML(r[1], t && t.nodeType ? t.ownerDocument || t : g, !0)
            ),
            x.test(r[1]) && xe.isPlainObject(t))
          )
            for (r in t)
      ...
      function () {
        ...
        for (
          'boolean' == typeof a && ((l = a), (a = arguments[1] || {}), (s = 2)),
            'object' == typeof a || xe.isFunction(a) || (a = {}),
            u === s && ((a = this), --s);
          s < u;
          s++
        )
          if (null != (i = arguments[s]))
            for (r in i)
              (e = a[r]),
                a !== (n = i[r]) &&
                  (l && n && (xe.isPlainObject(n) || (t = xe.isArray(n)))
                    ? ((o = t
                        ? ((t = !1), e && xe.isArray(e) ? e : [])
                        : e && xe.isPlainObject(e)
                        ? e
                        : {}),
                      (a[r] = xe.extend(l, o, n)))
                    : n !== k && (a[r] = n));
    ...
    xe.extend({
      ...
      noConflict: function (e) {
        return (
          h.$ === xe && (h.$ = f), e && h.jQuery === xe && (h.jQuery = o), xe
        );
      },
      isReady: !1,
      readyWait: 1,
      ...
      ready: function (e) {
        if (!0 === e ? !--xe.readyWait : !xe.isReady) {
          ...
          ((xe.isReady = !0) !== e && 0 < --xe.readyWait) ||
            (n.resolveWith(g, [xe]),
            xe.fn.trigger && xe(g).trigger('ready').off('ready'));
        }
      },
      ...
      isPlainObject: function (e) {
        var t;
        if (!e || 'object' !== xe.type(e) || e.nodeType || xe.isWindow(e))
          return !1;
        try {
          if (
            e.constructor &&
        ...
        if (xe.support.ownLast) for (t in e) return b.call(e, t);
        for (t in e);
        return t === k || b.call(e, t);
      },
      ...
      parseHTML: function (e, t, n) {
        ...
        return r
          ? [t.createElement(r[1])]
          : ((r = xe.buildFragment([e], t, i)),
            i && xe(i).remove(),
            xe.merge([], r.childNodes));
      },
      parseJSON: function (e) {
        return h.JSON && h.JSON.parse
          ...
          : 'string' == typeof e &&
            (e = xe.trim(e)) &&
            T.test(e.replace(C, '@').replace(N, ']').replace(w, ''))
          ? Function('return ' + e)()
          : (xe.error('Invalid JSON: ' + e), k);
      },
      parseXML: function (e) {
        var t;
        if (!e || 'string' != typeof e) return null;
    ...
    (xe.ready.promise = function (e) {
      if (!n)
        if (((n = xe.Deferred()), 'complete' === g.readyState))
          setTimeout(xe.ready);
        else if (g.addEventListener)
          g.addEventListener('DOMContentLoaded', H, !1),
            h.addEventListener('load', H, !1);
        else {
          g.attachEvent('onreadystatechange', H), h.attachEvent('onload', H);
          var t = !1;
          try {
    ...
    (function (n, i) {
      ...
      try {
        _.apply((e = M.call(E.childNodes)), E.childNodes),
      ...
      function re(e, t, n, r) {
          ...
          if ((i = Q.exec(e)))
            if ((a = i[1])) {
              ...
              if (
                ...
                return _.apply(n, t.getElementsByClassName(a)), n;
            }
          if (g.qsa && (!b || !b.test(e))) {
            if (
              ((f = c = k),
        ...
        return (function h(e, t, n, r) {
            ...
            for (
              ...
              if (
                ...
                (r = u(
                  ...
                  (X.test(o[0].type) && t.parentNode) || t
                ))
              ) {
          ...
          return m(e, l)(r, t, !v, n, X.test(e)), n;
        })(e.replace($, '$1'), t, n, r);
      }
      function ie() {
        var n = [];
      ...
      (y = re.setDocument =
        function (e) {
          var u = e ? e.ownerDocument || e : E,
            t = u.defaultView;
          return u !== N && 9 === u.nodeType && u.documentElement
            ? ((s = (N = u).documentElement),
              ...
              (g.getElementsByClassName = ae(function (e) {
                return (
                  (e.innerHTML =
              ...
              (g.getById = ae(function (e) {
                return (
                  (s.appendChild(e).id = k),
                  !u.getElementsByName || !u.getElementsByName(k).length
                );
              })),
              g.getById
              ...
              (w.find.TAG = g.getElementsByTagName
                ? function (e, t) {
              ...
              (c = []),
              (b = []),
              (g.qsa = G.test(u.querySelectorAll)) &&
                (ae(function (e) {
                  (e.innerHTML =
              ...
              (g.matchesSelector = G.test(
                ...
                ae(function (e) {
                  (g.disconnectedMatch = f.call(e, 'div')),
                    f.call(e, "[s!='']:x"),
                    c.push('!=', W);
                }),
              ...
              (x =
                G.test(s.contains) || s.compareDocumentPosition
                  ? function (e, t) {
      ...
      (re.matchesSelector = function (e, t) {
        if (
          ...
          (t = t.replace(U, "='$1']")),
          !(!g.matchesSelector || !v || (c && c.test(t)) || (b && b.test(t))))
        )
          try {
            var n = f.call(e, t);
            if (
      ...
      (re.contains = function (e, t) {
        return (e.ownerDocument || e) !== N && y(e), x(e, t);
      }),
      (re.attr = function (e, t) {
        (e.ownerDocument || e) !== N && y(e);
        var n = w.attrHandle[t.toLowerCase()],
          r = n && L.call(w.attrHandle, t.toLowerCase()) ? n(e, t, !v) : i;
        return r === i
          ? g.attributes || !v
            ? e.getAttribute(t)
      ...
      (re.uniqueSort = function (e) {
        var t,
          ...
          i = 0;
        if (
          ((A = !g.detectDuplicates),
          (l = !g.sortStable && e.slice(0)),
          e.sort(j),
          A)
        ) {
      ...
      { radio: !0, checkbox: !0, file: !0, password: !0, image: !0 }))
        w.pseudos[r] = le(r);
      for (r in { submit: !0, reset: !0 }) w.pseudos[r] = ce(r);
      function pe() {}
      function de(e, t) {
        var n,
          r,
        ...
        return (
          ...
          oe(function (e, t, n, r) {
            var i,
              ...
              f = !h || (!e && g) ? c : ye(c, s, h, n, r),
              p = m ? (v || (e ? h : l || y) ? [] : t) : f;
            if ((m && m(f, p, n, r), y))
              for (i = ye(p, u), y(i, [], n, r), o = i.length; o--; )
                (a = i[o]) && (p[u[o]] = !(f[u[o]] = a));
            if (e) {
              if (v || h) {
                if (v) {
                ...
                for (o = p.length; o--; )
                  (a = p[o]) &&
                    -1 < (i = v ? O.call(e, a) : s[o]) &&
                    (e[i] = !(t[i] = a));
              }
            } else (p = ye(p === t ? p.splice(l, p.length) : p)), v ? v(null, t, p, r) : _.apply(t, p);
          })
        );
      }
      function be(e) {
      ...
      (pe.prototype = w.filters = w.pseudos),
                  ...
                  var v = 0,
                    ...
                    e = function (e, t, n, r, i) {
                      var o,
                        ...
                        d = C,
                        h =
                          e || (x && w.find.TAG('*', (i && t.parentNode) || t)),
                        g = (S += null == d ? 1 : Math.random() || 0.1);
                      for (
                        p && ((C = t !== N && t), (T = v));
                        null != (o = h[c]);
                        c++
        ...
        (g.sortStable = k.split('').sort(j).join('') === k),
        (g.detectDuplicates = A),
        y(),
        (g.sortDetached = ae(function (e) {
        ...
        (xe.find = re),
        (xe.expr = re.selectors),
        (xe.expr[':'] = xe.expr.pseudos),
        (xe.unique = re.uniqueSort),
        (xe.text = re.getText),
        (xe.isXMLDoc = re.isXML),
        (xe.contains = re.contains);
    })(h);
  var M = {};
  (xe.Callbacks = function (i) {
      ...
      'string' == typeof i
        ? M[i] ||
          (function p(e) {
            var n = (M[e] = {});
            return (
              xe.each(e.match(S) || [], function (e, t) {
                n[t] = !0;
              }),
              n
            );
          ...
          return (
            u &&
              xe.each(arguments, function (e, t) {
                for (var n; -1 < (n = xe.inArray(t, u, n)); )
    ...
    (xe.support = (function (o) {
      ...
      if (
        ...
        return o;
      (a = (r = g.createElement('select')).appendChild(
      ...
      return (
        ...
        xe(function () {
          ...
          i &&
            ...
            xe.swap(i, null != i.style.zoom ? { zoom: 1 } : {}, function () {
            ...
            h.getComputedStyle &&
              ...
              ((t = c.appendChild(g.createElement('div'))).style.cssText =
                c.style.cssText =
                  r),
  ...
  function B(e, t, n, r) {
    if (xe.acceptData(e)) {
      var i,
        ...
        u = s ? xe.cache : e,
        l = s ? e[a] : e[a] && a;
      if ((l && u[l] && (r || u[l].data)) || n !== k || 'string' != typeof t)
        return (
          l || (l = s ? (e[a] = E.pop() || xe.guid++) : a),
          u[l] || (u[l] = s ? {} : { toJSON: xe.noop }),
          ('object' == typeof t || 'function' == typeof t) &&
            (r
              ? (u[l] = xe.extend(u[l], t))
              : (u[l].data = xe.extend(u[l].data, t))),
          (o = u[l]),
          r || (o.data || (o.data = {}), (o = o.data)),
          n !== k && (o[xe.camelCase(t)] = n),
          'string' == typeof t
            ? null == (i = o[t]) && (i = o[xe.camelCase(t)])
            : (i = o),
          i
        );
    }
    ...
    if (xe.acceptData(e)) {
      ...
      if (a[s]) {
        if (t && (r = n ? a[s] : a[s].data)) {
          i = (t = xe.isArray(t)
            ? t.concat(xe.map(t, xe.camelCase))
            : t in r
            ? [t]
            : (t = xe.camelCase(t)) in r
            ? [t]
            : t.split(' ')).length;
          for (; i--; ) delete r[t[i]];
        ...
        (n || (delete a[s].data, W(a[s]))) &&
          (o
            ? xe.cleanData([e], !0)
            : xe.support.deleteExpando || a != a.window
            ? delete a[s]
            : (a[s] = null));
      }
    }
  ...
  function W(e) {
    var t;
    for (t in e)
      if (('data' !== t || !xe.isEmptyObject(e[t])) && 'toJSON' !== t)
        return !1;
    return !0;
  }
  xe.extend({
    ...
    hasData: function (e) {
      return (
        !!(e = e.nodeType ? xe.cache[e[xe.expando]] : e[xe.expando]) && !W(e)
      );
    },
    data: function (e, t, n) {
      return B(e, t, n);
    ...
    xe.fn.extend({
      data: function (e, t) {
        ...
        if (
          this.length &&
          ((i = xe.data(a)), 1 === a.nodeType && !xe._data(a, 'parsedAttrs'))
        ) {
          for (n = a.attributes; n.length > o; o++)
            0 === (r = n[o].name).indexOf('data-') &&
              P(a, (r = xe.camelCase(r.slice(5))), i[r]);
    ...
    xe.fn.extend({
        ...
        return (
          ...
          e > arguments.length
            ...
            : this.each(function () {
                ...
                xe._queueHooks(this, t),
                  'fx' === t && 'inprogress' !== e[0] && xe.dequeue(this, t);
              })
        );
      },
      dequeue: function (e) {
      ...
      promise: function (e, t) {
        ...
        for ('string' != typeof e && ((t = e), (e = k)), e = e || 'fx'; a--; )
          (n = xe._data(o[a], e + 'queueHooks')) &&
            n.empty &&
            (r++, n.empty.add(s));
  ...
  xe.fn.extend({
    ...
    toggleClass: function (i, t) {
      ...
      return 'boolean' == typeof t && 'string' === o
        ...
        : this.each(function () {
            if ('string' === o)
              for (
                var e, t = 0, n = xe(this), r = i.match(S) || [];
                (e = r[t++]);
              ...
              (o === y || 'boolean' === o) &&
                (this.className &&
                  xe._data(this, '__className__', this.className),
                (this.className =
                  this.className || !1 === i
                    ? ''
                    : xe._data(this, '__className__') || ''));
          });
    },
    hasClass: function (e) {
      ...
      return arguments.length
        ? ((i = xe.isFunction(n)),
          this.each(function (e) {
            var t;
            1 === this.nodeType &&
              (null == (t = i ? n.call(this, e, xe(this).val()) : n)
                ? (t = '')
                : 'number' == typeof t
                ? (t += '')
                : xe.isArray(t) &&
                  (t = xe.map(t, function (e) {
                    return null == e ? '' : e + '';
                  })),
              ((r =
                ...
                'set' in r &&
                r.set(this, t, 'value') !== k) ||
                (this.value = t));
          }))
        : t
        ? (r = xe.valHooks[t.type] || xe.valHooks[t.nodeName.toLowerCase()]) &&
          'get' in r &&
          (e = r.get(t, 'value')) !== k
          ? e
    ...
    xe.extend({
      valHooks: {
        ...
        select: {
          get: function (e) {
            for (
              ...
              if (
                !(
                  (!(n = r[u]).selected && u !== i) ||
                  (xe.support.optDisabled
                    ? n.disabled
                    : null !== n.getAttribute('disabled')) ||
                  (n.parentNode.disabled &&
                    xe.nodeName(n.parentNode, 'optgroup'))
                )
              ) {
          ...
          set: function (e, t) {
            for (
              var n, r, i = e.options, o = xe.makeArray(t), a = i.length;
              a--;

            )
              ((r = i[a]).selected = 0 <= xe.inArray(xe(r).val(), o)) &&
                (n = !0);
      ...
      attr: function (e, t, n) {
        ...
        if (e && 3 !== o && 8 !== o && 2 !== o)
          return typeof e.getAttribute === y
            ...
            : ((1 === o && xe.isXMLDoc(e)) ||
                ((t = t.toLowerCase()),
                (r = xe.attrHooks[t] || (xe.expr.match.bool.test(t) ? I : $))),
              n === k
      ...
      removeAttr: function (e, t) {
        ...
        if (o && 1 === e.nodeType)
          for (; (n = o[i++]); )
            (r = xe.propFix[n] || n),
              xe.expr.match.bool.test(n)
                ? (G && J) || !Y.test(n)
                  ? (e[r] = !1)
                  : (e[xe.camelCase('default-' + n)] = e[r] = !1)
                : xe.attr(e, n, ''),
      ...
      prop: function (e, t, n) {
        ...
        if (e && 3 !== o && 8 !== o && 2 !== o)
          return (
            (1 !== o || !xe.isXMLDoc(e)) &&
              ((t = xe.propFix[t] || t), (i = xe.propHooks[t])),
            n !== k
              ? i && 'set' in i && (r = i.set(e, n, t)) !== k
                ? r
                : (e[t] = n)
      ...
      set: function (e, t, n) {
        return (
          !1 === t
            ? xe.removeAttr(e, n)
            : (G && J) || !Y.test(n)
            ? e.setAttribute((!J && xe.propFix[n]) || n, n)
            : (e[xe.camelCase('default-' + n)] = e[n] = !0),
          n
        );
      },
    }),
    xe.each(xe.expr.match.bool.source.match(/\w+/g), function (e, t) {
      ...
      xe.expr.attrHandle[t] =
        (G && J) || !Y.test(t)
          ? function (e, t, n) {
              var r = xe.expr.attrHandle[t],
                i = n
                  ? k
                  : (xe.expr.attrHandle[t] = k) != o(e, t, n)
                  ? t.toLowerCase()
                  : null;
      ...
      (($ = {
        set: function (e, t, n) {
          ...
          return (
            ...
            (r.value = t += ''),
            'value' === n || t === e.getAttribute(n) ? t : k
          );
        },
      }),
      (xe.expr.attrHandle.id =
        xe.expr.attrHandle.name =
        xe.expr.attrHandle.coords =
          function (e, t, n) {
            var r;
            return n
              ? k
    ...
    xe.support.hrefNormalized ||
      xe.each(['href', 'src'], function (e, t) {
        xe.propHooks[t] = {
          get: function (e) {
    ...
    xe.support.enctype || (xe.propFix.enctype = 'encoding'),
    xe.each(['radio', 'checkbox'], function () {
      (xe.valHooks[this] = {
        set: function (e, t) {
          return xe.isArray(t)
            ? (e.checked = 0 <= xe.inArray(xe(e).val(), t))
            : k;
        },
      }),
        xe.support.checkOn ||
  ...
  (xe.event = {
        ...
        for (
          n.handler && ((n = (u = n).handler), (i = u.selector)),
            ...
            (c = m.handle) ||
              ((c = m.handle =
                function (e) {
                  return typeof xe === y || (e && xe.event.triggered === e.type)
                    ? k
                    : xe.event.dispatch.apply(c.elem, arguments);
                }).elem = e),
          ...
          if (
            ...
            u &&
              ...
              ((f.teardown && !1 !== f.teardown.call(e, h, m.handle)) ||
                xe.removeEvent(e, d, m.handle),
              delete c[d]);
          } else for (d in c) xe.event.remove(e, d + t[l], n, r, !0);
    ...
    trigger: function (e, t, n, r) {
      ...
      if (
        ...
        3 !== n.nodeType &&
          8 !== n.nodeType &&
          !ee.test(p + xe.event.triggered) &&
          (0 <= p.indexOf('.') && ((p = (d = p.split('.')).shift()), d.sort()),
          (o = p.indexOf(':') < 0 && 'on' + p),
          ((e = e[xe.expando]
            ? e
            : new xe.Event(p, 'object' == typeof e && e)).isTrigger = r
            ? 2
            : 3),
          (e.namespace = d.join('.')),
        ...
        if (!r && !u.noBubble && !xe.isWindow(n)) {
          for (
            s = u.delegateType || p, ee.test(s + p) || (a = a.parentNode);
            a;
            a = a.parentNode
          )
            f.push(a), (l = a);
        ...
        for (c = 0; (a = f[c++]) && !e.isPropagationStopped(); )
          (e.type = 1 < c ? s : u.bindType || p),
            (i =
              (xe._data(a, 'events') || {})[e.type] && xe._data(a, 'handle')) &&
              i.apply(a, t),
            (i = o && a[o]) &&
              xe.acceptData(a) &&
              i.apply &&
    ...
    dispatch: function (e) {
      ...
      if (
        ...
        for (
          a = xe.event.handlers.call(this, e, u), t = 0;
      ...
      if (s && u.nodeType && (!e.button || 'click' !== e.type))
        for (; u != this; u = u.parentNode || this)
          if (1 === u.nodeType && (!0 !== u.disabled || 'click' !== e.type)) {
            for (i = [], o = 0; o < s; o++)
              i[(n = (r = t[o]).selector + ' ')] === k &&
                (i[n] = r.needsContext
                  ? 0 <= xe(n, this).index(u)
                  : xe.find(n, this, null, [u]).length),
                i[n] && i.push(r);
    ...
    fix: function (e) {
      ...
      for (
        a ||
          (this.fixHooks[i] = a =
            Z.test(i) ? this.mouseHooks : K.test(i) ? this.keyHooks : {}),
    ...
    simulate: function (e, t, n, r) {
      ...
      r ? xe.event.trigger(i, null, t) : xe.event.dispatch.call(t, i),
        i.isDefaultPrevented() && n.preventDefault();
    },
  }),
    (xe.removeEvent = g.removeEventListener
      ? function (e, t, n) {
      ...
      return this instanceof xe.Event
        ? (e && e.type
            ? ((this.originalEvent = e),
              (this.type = e.type),
              (this.isDefaultPrevented = e.defaultPrevented ? ne : Te))
            : (this.type = e),
          t && xe.extend(this, t),
    ...
    xe.support.submitBubbles ||
      (xe.event.special.submit = {
        setup: function () {
          return (
            !xe.nodeName(this, 'form') &&
            (xe.event.add(this, 'click._submit keypress._submit', function (e) {
              var t = e.target,
                n =
                  xe.nodeName(t, 'input') || xe.nodeName(t, 'button')
                    ? t.form
                    : k;
              n &&
                !xe._data(n, 'submitBubbles') &&
                (xe.event.add(n, 'submit._submit', function (e) {
                  e._submit_bubble = !0;
                }),
        ...
        postDispatch: function (e) {
          e._submit_bubble &&
            ...
            this.parentNode &&
              !e.isTrigger &&
              xe.event.simulate('submit', this.parentNode, e, !0));
        },
        teardown: function () {
          return (
            !xe.nodeName(this, 'form') && (xe.event.remove(this, '._submit'), k)
          );
        },
      }),
    xe.support.changeBubbles ||
      (xe.event.special.change = {
        setup: function () {
          return Q.test(this.nodeName)
            ? (('checkbox' === this.type || 'radio' === this.type) &&
                (xe.event.add(this, 'propertychange._change', function (e) {
                ...
                xe.event.add(this, 'click._change', function (e) {
                  this._just_changed &&
                    ...
                    xe.event.simulate('change', this, e, !0);
                })),
              !1)
            : (xe.event.add(this, 'beforeactivate._change', function (e) {
                var t = e.target;
                Q.test(t.nodeName) &&
                  !xe._data(t, 'changeBubbles') &&
                  (xe.event.add(t, 'change._change', function (e) {
                    !this.parentNode ||
                      e.isSimulated ||
                      e.isTrigger ||
                      xe.event.simulate('change', this.parentNode, e, !0);
                  }),
    ...
    xe.fn.extend({
      on: function (e, t, n, r, i) {
        var o, a;
        if ('object' == typeof e) {
          for (o in ('string' != typeof t && ((n = n || t), (t = k)), e))
            this.on(o, t, n, e[o], i);
          return this;
        }
        if (
      ...
      triggerHandler: function (e, t) {
        var n = this[0];
        return n ? xe.event.trigger(e, t, n, !0) : k;
      },
    });
  var ie = /^.[^:#\[\.,]*$/,
  ...
  function le(e, n, r) {
    ...
    if ('string' == typeof n) {
      if (ie.test(n)) return xe.filter(n, e, r);
      n = xe.filter(n, e);
    }
    return xe.grep(e, function (e) {
  ...
  xe.fn.extend({
      ...
      if ('string' != typeof e)
        return this.pushStack(
          xe(e).filter(function () {
            for (t = 0; t < i; t++) if (xe.contains(r[t], this)) return !0;
          })
        );
    ...
    has: function (e) {
      ...
      return this.filter(function () {
        for (t = 0; t < r; t++) if (xe.contains(this, n[t])) return !0;
      });
    },
    not: function (e) {
    ...
    is: function (e) {
      return !!le(
        this,
        'string' == typeof e && ae.test(e) ? xe(e) : e || [],
        !1
      ).length;
    },
    closest: function (e, t) {
      for (
        var n,
          ...
          i = this.length,
          o = [],
          a = ae.test(e) || 'string' != typeof e ? xe(e, t || this.context) : 0;
        r < i;
        r++
      )
    ...
    index: function (e) {
      return e
        ? 'string' == typeof e
          ? xe.inArray(this[0], xe(e))
          : xe.inArray(e.jquery ? e[0] : e, this)
    ...
    xe.each(
      ...
      function (r, i) {
        xe.fn[r] = function (e, t) {
          ...
          return (
            'Until' !== r.slice(-5) && (t = e),
            t && 'string' == typeof t && (n = xe.filter(t, n)),
            1 < this.length &&
              (se[r] || (n = xe.unique(n)), oe.test(r) && (n = n.reverse())),
            this.pushStack(n)
          );
        };
      }
  ...
  var fe =
    ...
    Se = {
      ...
      _default: xe.support.htmlSerialize
        ? [0, '', '']
        : [1, 'X<div>', '</div>'],
    },
    Ae = ce(g).appendChild(g.createElement('div'));
  function je(e, t) {
    return xe.nodeName(e, 'table') &&
      xe.nodeName(1 === t.nodeType ? t : t.firstChild, 'tr')
  ...
  function He(e, t) {
    for (var n, r = 0; null != (n = e[r]); r++)
      xe._data(n, 'globalEval', !t || xe._data(t[r], 'globalEval'));
  }
  function qe(e, t) {
  ...
  function Me(e, t) {
    ...
    if (!o)
      for (o = [], n = e.childNodes || e; null != (r = n[i]); i++)
        !t || xe.nodeName(r, t) ? o.push(r) : xe.merge(o, Me(r, t));
    return t === k || (t && xe.nodeName(e, t)) ? xe.merge([e], o) : o;
  }
  function Oe(e) {
  ...
  (Se.optgroup = Se.option),
    ...
    xe.fn.extend({
      ...
      remove: function (e, t) {
        for (
          var n, r = e ? xe.filter(e, this) : this, i = 0;
          null != (n = r[i]);
          i++
        )
          t || 1 !== n.nodeType || xe.cleanData(Me(n)),
            n.parentNode &&
              (t && xe.contains(n.ownerDocument, n) && He(Me(n, 'script')),
              n.parentNode.removeChild(n));
        return this;
      },
      empty: function () {
        for (var e, t = 0; null != (e = this[t]); t++) {
          for (1 === e.nodeType && xe.cleanData(Me(e, !1)); e.firstChild; )
        ...
        return xe.access(
          ...
          function (e) {
            var t = this[0] || {},
              ...
              r = this.length;
            if (e === k)
              return 1 === t.nodeType ? t.innerHTML.replace(pe, '') : k;
            if (
              !(
                'string' != typeof e ||
                be.test(e) ||
                (!xe.support.htmlSerialize && de.test(e)) ||
                (!xe.support.leadingWhitespace && he.test(e)) ||
                Se[(me.exec(e) || ['', ''])[1].toLowerCase()]
              )
            ) {
              e = e.replace(ge, '<$1></$2>');
              try {
                for (; n < r; n++)
                  1 === (t = this[n] || {}).nodeType &&
                    (xe.cleanData(Me(t, !1)), (t.innerHTML = e));
                t = 0;
              } catch (i) {}
            }
      ...
      domManip: function (n, r, i) {
        ...
        if (
          h ||
          (!(c <= 1 || 'string' != typeof d || xe.support.checkClone) &&
            Ce.test(d))
        )
          return this.each(function (e) {
            var t = f.eq(e);
        ...
        if (
          c &&
          ((e = (u = xe.buildFragment(n, this[0].ownerDocument, !1, !i && this))
            .firstChild),
          1 === u.childNodes.length && (u = e),
          e)
        ) {
          for (o = (a = xe.map(Me(u, 'script'), De)).length; l < c; l++)
            (t = u),
              l !== p &&
                ((t = xe.clone(t, !0, !0)), o && xe.merge(a, Me(t, 'script'))),
              r.call(this[l], t, l);
          if (o)
            for (
              s = a[a.length - 1].ownerDocument, xe.map(a, Le), l = 0;
              l < o;
              l++
            )
              (t = a[l]),
                Ne.test(t.type || '') &&
                  !xe._data(t, 'globalEval') &&
                  xe.contains(s, t) &&
                  (t.src
                    ? xe._evalUrl(t.src)
                    : xe.globalEval(
    ...
    xe.each(
      ...
      function (e, a) {
        xe.fn[e] = function (e) {
          for (var t, n = 0, r = [], i = xe(e), o = i.length - 1; n <= o; n++)
    ...
    xe.extend({
      clone: function (e, t, n) {
        ...
        if (
          ...
          !(
            (xe.support.noCloneEvent && xe.support.noCloneChecked) ||
            (1 !== e.nodeType && 11 !== e.nodeType) ||
            xe.isXMLDoc(e)
          ))
        )
          for (r = Me(o), s = Me(e), a = 0; null != (i = s[a]); ++a)
            r[a] && _e(i, r[a]);
        if (t)
          if (n)
            for (s = s || Me(e), r = r || Me(o), a = 0; null != (i = s[a]); a++)
              qe(i, r[a]);
          else qe(e, o);
        return (
          0 < (r = Me(o, 'script')).length && He(r, !u && Me(e, 'script')),
          (r = s = i = null),
          o
        );
      },
      buildFragment: function (e, t, n, r) {
        for (
          var i, o, a, s, u, l, c, f = e.length, p = ce(t), d = [], h = 0;
          h < f;
          h++
        )
          if ((o = e[h]) || 0 === o)
            if ('object' === xe.type(o)) xe.merge(d, o.nodeType ? [o] : o);
              ...
              for (
                ...
                s = s.lastChild;
              if (
                (!xe.support.leadingWhitespace &&
                  he.test(o) &&
                  d.push(t.createTextNode(he.exec(o)[0])),
                !xe.support.tbody)
              )
                for (
                  i =
                  ...
                  xe.nodeName((l = o.childNodes[i]), 'tbody') &&
                    !l.childNodes.length &&
                    o.removeChild(l);
              for (
                xe.merge(d, s.childNodes), s.textContent = '';
                s.firstChild;
        ...
        for (
          s && p.removeChild(s),
            xe.support.appendChecked || xe.grep(Me(d, 'input'), Oe),
            h = 0;
          (o = d[h++]);
          ...
          if (
            (!r || -1 === xe.inArray(o, r)) &&
            ((a = xe.contains(o.ownerDocument, o)),
            (s = Me(p.appendChild(o), 'script')),
            a && He(s),
            n)
          )
      ...
      cleanData: function (e, t) {
        for (
          ...
          if ((t || xe.acceptData(n)) && (o = (i = n[s]) && u[i])) {
            if (o.events)
              for (r in o.events)
                c[r] ? xe.event.remove(n, r) : xe.removeEvent(n, r, o.handle);
            u[i] &&
              (delete u[i],
              l
                ? delete n[s]
  ...
  function Ze(e, t) {
    if (t in e) return t;
    for (
      var n = t.charAt(0).toUpperCase() + t.slice(1), r = t, i = Ke.length;
      i--;
  ...
  function et(e, t) {
    return (
      (e = t || e),
      'none' === xe.css(e, 'display') || !xe.contains(e.ownerDocument, e)
    );
  }
  function tt(e, t) {
    for (var n, r, i, o = [], a = 0, s = e.length; a < s; a++)
      (r = e[a]).style &&
        ((o[a] = xe._data(r, 'olddisplay')),
        (n = r.style.display),
        t
          ? (o[a] || 'none' !== n || (r.style.display = ''),
            '' === r.style.display &&
              et(r) &&
              (o[a] = xe._data(r, 'olddisplay', ot(r.nodeName))))
          : o[a] ||
            ((i = et(r)),
            ((n && 'none' !== n) || !i) &&
              xe._data(r, 'olddisplay', i ? n : xe.css(r, 'display'))));
    for (a = 0; a < s; a++)
      (r = e[a]).style &&
  ...
  function rt(e, t, n, r, i) {
    for (
      ...
      'margin' === n && (a += xe.css(e, n + Qe[o], !0, i)),
        r
          ? ('content' === n && (a -= xe.css(e, 'padding' + Qe[o], !0, i)),
            'margin' !== n &&
              (a -= xe.css(e, 'border' + Qe[o] + 'Width', !0, i)))
          : ((a += xe.css(e, 'padding' + Qe[o], !0, i)),
            'padding' !== n &&
              (a += xe.css(e, 'border' + Qe[o] + 'Width', !0, i)));
    return a;
  }
  function it(e, t, n) {
    var r = !0,
      ...
      o = Be(e),
      a =
        xe.support.boxSizing && 'border-box' === xe.css(e, 'boxSizing', !1, o);
    if (i <= 0 || null == i) {
      if (
        (((i = Re(e, t, o)) < 0 || null == i) && (i = e.style[t]), Ue.test(i))
      )
        return i;
      (r = a && (xe.support.boxSizingReliable || i === e.style[t])),
        (i = parseFloat(i) || 0);
    }
      ...
      n ||
        (('none' !== (n = at(e, t)) && n) ||
          ((t = (
            (Fe = (
              Fe ||
              xe("<iframe frameborder='0' width='0' height='0'/>").css(
                'cssText',
  ...
  xe.fn.extend({
    css: function (e, t) {
      return xe.access(
        ...
        function (e, t, n) {
          ...
          return n !== k ? xe.style(e, t, n) : xe.css(e, t);
        },
        e,
        t,
        1 < arguments.length
    ...
    xe.extend({
      ...
      cssProps: { float: xe.support.cssFloat ? 'cssFloat' : 'styleFloat' },
      style: function (e, t, n, r) {
        if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
          var i,
            ...
            u = e.style;
          if (
            ((t = xe.cssProps[s] || (xe.cssProps[s] = Ze(u, s))),
            (a = xe.cssHooks[t] || xe.cssHooks[s]),
            n === k)
          )
            return a && 'get' in a && (i = a.get(e, !1, r)) !== k ? i : u[t];
          if (
            ('string' === (o = typeof n) &&
              (i = Ve.exec(n)) &&
              ((n = (i[1] + 1) * i[2] + parseFloat(xe.css(e, t))),
              (o = 'number')),
            !(
              null == n ||
              ('number' === o && isNaN(n)) ||
              ('number' !== o || xe.cssNumber[s] || (n += 'px'),
              xe.support.clearCloneStyle ||
                '' !== n ||
                0 !== t.indexOf('background') ||
                (u[t] = 'inherit'),
              a && 'set' in a && (n = a.set(e, n, r)) === k)
            ))
          )
            try {
              u[t] = n;
      ...
      css: function (e, t, n, r) {
        var i,
          ...
          s = xe.camelCase(t);
        return (
          (t = xe.cssProps[s] || (xe.cssProps[s] = Ze(e.style, s))),
          (a = xe.cssHooks[t] || xe.cssHooks[s]) &&
            'get' in a &&
            (o = a.get(e, !0, n)),
          o === k && (o = Re(e, t, r)),
          ...
          '' === n || n
            ? ((i = parseFloat(o)), !0 === n || xe.isNumeric(i) ? i || 0 : o)
            : o
        );
      },
    }),
    ...
    xe.each(['height', 'width'], function (e, i) {
      xe.cssHooks[i] = {
        get: function (e, t, n) {
          return t
            ? 0 === e.offsetWidth && Ie.test(xe.css(e, 'display'))
              ? xe.swap(e, Je, function () {
                  return it(e, i, n);
                })
              : it(e, i, n)
            : k;
          ...
          return nt(
            ...
            n
              ? rt(
                  ...
                  i,
                  n,
                  xe.support.boxSizing &&
                    'border-box' === xe.css(e, 'boxSizing', !1, r),
                  r
                )
              : 0
          );
    ...
    xe.support.opacity ||
      (xe.cssHooks.opacity = {
        ...
        set: function (e, t) {
          ...
          (((n.zoom = 1) <= t || '' === t) &&
            '' === xe.trim(o.replace(Pe, '')) &&
            n.removeAttribute &&
            (n.removeAttribute('filter'), '' === t || (r && !r.filter))) ||
            (n.filter = Pe.test(o) ? o.replace(Pe, i) : o + ' ' + i);
        },
      }),
    xe(function () {
      xe.support.reliableMarginRight ||
        (xe.cssHooks.marginRight = {
          get: function (e, t) {
            return t
              ? xe.swap(e, { display: 'inline-block' }, Re, [e, 'marginRight'])
              : k;
          },
        }),
        !xe.support.pixelPosition &&
          xe.fn.position &&
          xe.each(['top', 'left'], function (e, n) {
            xe.cssHooks[n] = {
              get: function (e, t) {
                return t
                  ? ((t = Re(e, n)),
                    Ue.test(t) ? xe(e).position()[n] + 'px' : t)
                  : k;
              },
            };
          });
    ...
    xe.expr &&
      xe.expr.filters &&
      ((xe.expr.filters.hidden = function (e) {
        return (
          (e.offsetWidth <= 0 && e.offsetHeight <= 0) ||
          (!xe.support.reliableHiddenOffsets &&
            'none' === ((e.style && e.style.display) || xe.css(e, 'display')))
        );
      }),
      (xe.expr.filters.visible = function (e) {
        return !xe.expr.filters.hidden(e);
      })),
    xe.each({ margin: '', padding: '', border: 'Width' }, function (i, o) {
      (xe.cssHooks[i + o] = {
        expand: function (e) {
          for (
  ...
  xe.fn.extend({
    ...
    (xe.param = function (e, t) {
      var n,
        r = [],
        i = function (e, t) {
          (t = xe.isFunction(t) ? t() : null == t ? '' : t),
            (r[r.length] = encodeURIComponent(e) + '=' + encodeURIComponent(t));
        };
      if (
        (t === k && (t = xe.ajaxSettings && xe.ajaxSettings.traditional),
        xe.isArray(e) || (e.jquery && !xe.isPlainObject(e)))
      )
        xe.each(e, function () {
  ...
  (dt = wt.exec(ht.toLowerCase()) || []),
    ...
    xe.extend({
      ...
      ajax: function (e, t) {
        ...
        var n,
          ...
          y = xe.ajaxSetup({}, t),
          v = y.context || y,
          b = y.context && (v.nodeType || v.jquery) ? xe(v) : xe.event,
          x = xe.Deferred(),
          T = xe.Callbacks('once memory'),
          w = y.statusCode || {},
          o = {},
          a = {},
          C = 0,
          ...
          N = {
            ...
            getResponseHeader: function (e) {
              ...
              if (2 === C) {
                if (!i)
                  for (i = {}; (t = bt.exec(d)); ) i[t[1].toLowerCase()] = t[2];
                t = i[e.toLowerCase()];
              }
        ...
        if (
          ...
          y.data &&
            ...
            (y.data = xe.param(y.data, y.traditional)),
          At(Nt, y, t, N),
          2 === C)
        )
          return N;
        ...
        (y.hasContent = !xt.test(y.type)),
        (p = y.url),
        y.hasContent ||
          (y.data &&
            ((p = y.url += (mt.test(p) ? '&' : '?') + y.data), delete y.data),
          !1 === y.cache &&
            (y.url = vt.test(p)
              ? p.replace(vt, '$1_=' + gt++)
              : p + (mt.test(p) ? '&' : '?') + '_=' + gt++)),
        y.ifModified &&
          (xe.lastModified[p] &&
            N.setRequestHeader('If-Modified-Since', xe.lastModified[p]),
          xe.etag[p] && N.setRequestHeader('If-None-Match', xe.etag[p])),
        ((y.data && y.hasContent && !1 !== y.contentType) || t.contentType) &&
          N.setRequestHeader('Content-Type', y.contentType),
        N.setRequestHeader(
          'Accept',
          y.dataTypes[0] && y.accepts[y.dataTypes[0]]
            ? y.accepts[y.dataTypes[0]] +
                ('*' !== y.dataTypes[0] ? ', ' + Et + '; q=0.01' : '')
            : y.accepts['*']
        ),
        y.headers))
          N.setRequestHeader(r, y.headers[r]);
        if (y.beforeSend && (!1 === y.beforeSend.call(v, N, y) || 2 === C))
          return N.abort();
        for (r in ((s = 'abort'), { success: 1, error: 1, complete: 1 }))
          N[r](y[r]);
        if ((m = At(kt, y, t, N))) {
          (N.readyState = 1),
            g && b.trigger('ajaxSend', [N, y]),
            y.async &&
              0 < y.timeout &&
          ...
          2 !== C &&
            ...
            n &&
              (s = (function c(e, t, n) {
                ...
                return o ? (o !== u[0] && u.unshift(o), n[o]) : k;
              })(y, N, n)),
            (s = (function f(e, t, n, r) {
              var i,
                o,
                a,
                s,
            ...
            i
              ? (y.ifModified &&
                  ((u = N.getResponseHeader('Last-Modified')) &&
                    (xe.lastModified[p] = u),
                  (u = N.getResponseHeader('etag')) && (xe.etag[p] = u)),
                204 === e || 'HEAD' === y.type
                  ? (l = 'nocontent')
                  : 304 === e
                  ? (l = 'notmodified')
            ...
            (N.status = e),
            (N.statusText = (t || l) + ''),
            i ? x.resolveWith(v, [o, l, N]) : x.rejectWith(v, [N, l, a]),
            N.statusCode(w),
            (w = k),
            g && b.trigger(i ? 'ajaxSuccess' : 'ajaxError', [N, y, i ? o : a]),
            T.fireWith(v, [N, l]),
            g &&
              (b.trigger('ajaxComplete', [N, y]),
      ...
      getScript: function (e, t) {
        return xe.get(e, k, t, 'script');
      },
    }),
    xe.each(['get', 'post'], function (e, i) {
      xe[i] = function (e, t, n, r) {
        return (
          xe.isFunction(t) && ((r = r || n), (n = t), (t = k)),
          xe.ajax({ url: e, type: i, dataType: r, data: t, success: n })
        );
      };
    }),
    xe.ajaxSetup({
    ...
    xe.ajaxTransport('script', function (t) {
      if (t.crossDomain) {
        var r,
          i = g.head || xe('head')[0] || g.documentElement;
        return {
          send: function (e, n) {
  ...
  xe.ajaxSetup({
    ...
    xe.ajaxPrefilter('json jsonp', function (e, t, n) {
      ...
      return a || 'jsonp' === e.dataTypes[0]
        ? ((r = e.jsonpCallback =
            xe.isFunction(e.jsonpCallback)
              ? e.jsonpCallback()
              : e.jsonpCallback),
          a
            ? (e[a] = e[a].replace(Lt, '$1' + r))
            : !1 !== e.jsonp &&
  ...
  (xe.ajaxSettings.xhr = h.ActiveXObject
    ? function () {
        return (
          (!this.isLocal && Ot()) ||
          (function e() {
    ...
    : Ot),
    (qt = xe.ajaxSettings.xhr()),
    (xe.support.cors = !!qt && 'withCredentials' in qt),
    (qt = xe.support.ajax = !!qt) &&
      xe.ajaxTransport(function (l) {
        var c;
        if (!l.crossDomain || xe.support.cors)
          return {
            send: function (e, a) {
              var s,
                t,
              ...
              u.send((l.hasContent && l.data) || null),
                ...
                l.async
                  ? 4 === u.readyState
                    ? setTimeout(c)
                    : ((s = ++_t),
                      Mt && (Ht || ((Ht = {}), xe(h).unload(Mt)), (Ht[s] = c)),
    ...
    $t = [
      function Qt(t, e, n) {
        var r,
          ...
          d = xe._data(t, 'fxshow');
        for (r in (n.queue ||
          (null == (s = xe._queueHooks(t, 'fx')).unqueued &&
            ((s.unqueued = 0),
            (u = s.empty.fire),
        ...
        1 === t.nodeType &&
          ...
          'inline' === xe.css(t, 'display') &&
            'none' === xe.css(t, 'float') &&
            (xe.support.inlineBlockNeedsLayout && 'inline' !== ot(t.nodeName)
              ? (f.zoom = 1)
              : (f.display = 'inline-block'))),
        n.overflow &&
          ((f.overflow = 'hidden'),
          xe.support.shrinkWrapBlocks ||
            l.always(function () {
      ...
      '*': [
        function (e, t) {
          var n = this.createTween(e, t),
            ...
            a =
              (xe.cssNumber[e] || ('px' !== o && +r)) &&
              Pt.exec(xe.css(n.elem, e)),
            s = 1,
            u = 20;
          if (a && a[3] !== o)
            for (
  ...
  function Xt(e, t, n) {
    for (
      var r, i = (It[t] || []).concat(It['*']), o = 0, a = i.length;
      o < a;
      o++
    )
  ...
  function Ut(o, e, t) {
    var n,
      ...
      l = s.promise({
        elem: o,
        props: xe.extend({}, e),
        opts: xe.extend(!0, { specialEasing: {} }, t),
    ...
    return (
      xe.map(c, Xt, l),
      xe.isFunction(l.opts.start) && l.opts.start.call(o, l),
      xe.fx.timer(xe.extend(u, { elem: o, anim: l, queue: l.opts.queue })),
      l
  ...
  function Yt(e, t) {
    ...
    for (t = t ? 1 : 0; i < 4; i += 2 - t)
      r['margin' + (n = Qe[i])] = r['padding' + n] = e;
    return t && (r.opacity = r.width = e), r;
  }
  function Jt(e) {
    return xe.isWindow(e)
      ? e
  ...
  (xe.Animation = xe.extend(Ut, {
    tweener: function (e, t) {
      for (
        var n,
          r = 0,
          i = (e = xe.isFunction(e) ? ((t = e), ['*']) : e.split(' ')).length;
        r < i;
        r++
      )
    ...
    xe.fn.extend({
      ...
      animate: function (t, e, n, r) {
        var i = xe.isEmptyObject(t),
          o = xe.speed(e, n, r),
          a = function () {
            var e = Ut(this, xe.extend({}, t), o);
            (i || xe._data(this, 'finish')) && e.stop(!0);
          };
        return (
          (a.finish = a),
    ...
    (xe.speed = function (e, t, n) {
      ...
      return (
        (r.duration = xe.fx.off
          ? 0
          : 'number' == typeof r.duration
          ? r.duration
          : r.duration in xe.fx.speeds
          ? xe.fx.speeds[r.duration]
          : xe.fx.speeds._default),
        (null == r.queue || !0 === r.queue) && (r.queue = 'fx'),
        (r.old = r.complete),
        (r.complete = function () {
          xe.isFunction(r.old) && r.old.call(this),
    ...
    (xe.timers = []),
    (xe.fx = Vt.prototype.init),
    (xe.fx.tick = function () {
      var e,
        t = xe.timers,
        n = 0;
      for (Ft = xe.now(); t.length > n; n++)
        (e = t[n])() || t[n] !== e || t.splice(n--, 1);
      t.length || xe.fx.stop(), (Ft = k);
    }),
    ...
    xe.expr &&
      xe.expr.filters &&
      (xe.expr.filters.animated = function (t) {
    ...
    (xe.fn.offset = function (t) {
      ...
      return o
        ? ((e = o.documentElement),
          xe.contains(e, i)
            ? (typeof i.getBoundingClientRect !== y &&
    ...
    (xe.offset = {
      setOffset: function (e, t, n) {
        ...
        var i,
          ...
          f = {};
        (o =
          ('absolute' === r || 'fixed' === r) && -1 < xe.inArray('auto', [u, l])
            ? ((i = (f = a.position()).top), f.left)
            : ((i = parseFloat(u) || 0), parseFloat(l) || 0)),
          xe.isFunction(t) && (t = t.call(e, n, s)),
      ...
      position: function () {
        if (this[0]) {
          var e,
            ...
            r = this[0];
          return (
            'fixed' === xe.css(r, 'position')
              ? (t = r.getBoundingClientRect())
              : ((e = this.offsetParent()),
                (t = this.offset()),
                xe.nodeName(e[0], 'html') || (n = e.offset()),
                (n.top += xe.css(e[0], 'borderTopWidth', !0)),
                (n.left += xe.css(e[0], 'borderLeftWidth', !0))),
            {
      ...
      offsetParent: function () {
        return this.map(function () {
          for (
            ...
            e && !xe.nodeName(e, 'html') && 'static' === xe.css(e, 'position');
    ...
    xe.each({ Height: 'height', Width: 'width' }, function (o, a) {
      xe.each(
