...
EDQ.system.logError = function logError(obj) {
  if (window.console) {
    window.console.log('EDQ: ' + obj);
  } else {
    //IE does not have a logger.
    //alert(obj);
  }
};
...
EDQ.DataQuality.Configuration.prototype.addInputMapping =
  function addInputMapping(edqFieldName, elementIdOrIds) {
    this._addMapping(this._inputMappings, edqFieldName, elementIdOrIds);
  };

EDQ.DataQuality.Configuration.prototype._getElementLabelFromInputMappingByEdqFieldName =
  function _getElementLabelFromInputMappingByEdqFieldName(edqFieldName) {
    var sys = EDQ.system;
...
EDQ.DataQuality.Configuration.prototype._getElementFromInputMappingByEdqFieldName =
  function _getElementFromInputMappingByEdqFieldName(edqFieldName) {
    var sys = EDQ.system;
...
EDQ.DataQuality.Configuration.prototype.addDataSetSetting =
  function addDataSetSetting(
    elementId,
    edqFieldNameOrNames,
    dataSet,
    layout,
...
EDQ.DataQuality.Configuration.prototype.getDataSetSettings =
  function getDataSetSettings(dataset) {
    var sys = EDQ.system;
...
EDQ.DataQuality.Client.prototype._callOnValidationStart =
  function _callOnValidationStart(configuration, findAddressElement) {
    var sys = EDQ.system;

    if (sys.isFunction(this.onBeforeValidationStart)) {
      return (
        this.onBeforeValidationStart(configuration, findAddressElement) !==
        false
...
EDQ.DataQuality.Client.prototype._callOnAfterValidationEnd =
  function _callOnAfterValidationEnd(configuration, result) {
    var sys = EDQ.system;
...
EDQ.DataQuality.Client.prototype.createConfigurationsFor =
  function createConfigurationsFor(mappings) {
    var sys = EDQ.system;
    var dq = EDQ.DataQuality;
    ...
    for (var i = 0; i < mappings.length; i++) {
      ...
      configuration.ServiceValidationTimeoutInMilliseconds =
        mappingJSON.ServiceValidationTimeoutInSeconds
...
EDQ.DataQuality.Client.prototype._initializeForConfiguration =
  function _initializeForConfiguration(configuration) {};

EDQ.DataQuality.Client.prototype._executeXMLHttpRequest =
  function _executeXMLHttpRequest(
    url,
    parameters,
...
EDQ.DataQuality.Client.prototype._hideAllInputMappingElementsExcept =
  function _hideAllInputMappingElementsExcept(inputMappings, edqFieldNames) {
    var sys = EDQ.system;
...
EDQ.DataQuality.Client.prototype._showElementAndLabel =
  function _showElementAndLabel(elementIds) {
    this._executeActionOnElementAndLabel(
      elementIds,
      EDQ.DataQuality.Client.showElement
    );
  };
EDQ.DataQuality.Client.prototype._hideElementAndLabel =
  function _hideElementAndLabel(elementIds) {
    this._executeActionOnElementAndLabel(
      elementIds,
      EDQ.DataQuality.Client.hideElement
    );
  };
EDQ.DataQuality.Client.prototype._executeActionOnElementAndLabel =
  function _executeActionOnElementAndLabel(elementIds, action) {
    var sys = EDQ.system;
...
EDQ.DataQuality.Client.prototype._handleErrorMessage =
  function _handleErrorMessage(configuration, edqFieldForMessage, message) {
    var sys = EDQ.system;
    var dq = EDQ.DataQuality;
...
EDQ.DataQuality.Client.prototype.isEdqFieldNameSetValueAllowedForValidationStatus =
  function isEdqFieldNameSetValueAllowedForValidationStatus(
    edqFieldName,
    validationStatus
  ) {
    return true;
...
EDQ.DataQuality.Client._executeShowOrHideElementContainerOrElement =
  function _executeShowOrHideElementContainerOrElement(element, show) {
    var sys = EDQ.system;
    var dq = EDQ.DataQuality;
    var client = dq.Client;
...
EDQ.DataQuality.Client._isElementContainerOrElementVisible =
  function _isElementContainerOrElementVisible(element) {
    var sys = EDQ.system;
    var client = EDQ.DataQuality.Client;
...
EDQ.DataQuality.Client.getConcatenatedElementValues =
  function getConcatenatedElementValues(elementIds, snapshot) {
    var sys = EDQ.system;
...
EDQ.DataQuality.Client.prototype.getConfigurationSnapshot =
  function getConfigurationSnapshot(configuration) {
    var client = EDQ.DataQuality.Client;
...
EDQ.DataQuality.Client.prototype.getConfigurationId =
  function getConfigurationId(configuration) {
    return this._configurations.indexOf(configuration);
  };
EDQ.DataQuality.Client.prototype.restoreValuesFromSnapshot =
  function restoreValuesFromSnapshot(snapshot, mapping) {
    /*var sys = EDQ.system;
...
EDQ.DataQuality.Client._tryGetElementContainer =
  function _tryGetElementContainer(element) {
...
EDQ.DataQuality.Client._createInlineMessageElement =
  function _createInlineMessageElement(element, message) {
    var sys = EDQ.system;
...
EDQ.DataQuality.Client._excludeStoreLocalization =
  function _excludeStoreLocalization(url) {
    var sys = EDQ.system;
...
EDQ.DataQuality.Address.Configuration.prototype.addOriginalInputMapping =
  function addOriginalInputMapping(edqFieldName, elementIdOrIds) {
    this._addMapping(this._originalInputMappings, edqFieldName, elementIdOrIds);
  };

EDQ.DataQuality.Address.Configuration.prototype._createInputMappingsAndDataSetSettingsFor =
  function _createInputMappingsAndDataSetSettingsFor(
    mappingJSON,
    configurationId
  ) {
    var sys = EDQ.system;
...
EDQ.DataQuality.Address.Configuration.prototype._createInputMappingFor =
  function _createInputMappingFor(
    inputMappingJSON,
    configurationId,
    inputMappingType
  ) {
...
EDQ.DataQuality.Address.Configuration.prototype._createDataSetSettingsFor =
  function _createDataSetSettingsFor(dataSetSettingsJSON) {
    var sys = EDQ.system;
    var dq = EDQ.DataQuality;
...
EDQ.DataQuality.Address.Configuration.prototype.injectInputMappingFields =
  function injectInputMappingFields(injectSystemFields, injectPromptSetFields) {
    var sys = EDQ.system;
    var dq = EDQ.DataQuality;
    ...
    var insertAfterElementId =
      this._getElementIdOfLastElementInOriginalInputMapping();
    var streetElementId = this._originalInputMappings[dq.Street][0];

    dq.Configuration.ElementContainerDepth =
      addressClient._getElementContainerDepth(
    ...
    if (!sys.isNull(exampleElement) && !sys.isNull(insertAfterElement)) {
      var exampleElementContainer =
        EDQ.DataQuality.Client._tryGetElementContainer(exampleElement);
      var insertAfterElementContainer =
        EDQ.DataQuality.Client._tryGetElementContainer(insertAfterElement);
            ...
            if (
              ...
              if (!isGroup) {
                ...
                if (cleanContainer) {
                  ...
                  htmlCopy1
                    .find('#' + streetElementId)
                    .replaceWith(elementHtml);
...
EDQ.DataQuality.Address.Configuration.prototype._getElementIdOfLastElementInOriginalInputMapping =
  function _getElementIdOfLastElementInOriginalInputMapping() {
    var last = undefined;
      ...
      for (var i = 0; i < elementIds.length; i++) {
        ...
        if (element.size() > 0) {
          if (!last) {
            ...
            var containerOfElement =
              EDQ.DataQuality.Client._tryGetElementContainer(element.get(0));
            var containerOfLast =
              EDQ.DataQuality.Client._tryGetElementContainer(last.get(0));

            var containerOfElementJQueryElement =
              EDQ.JQuery(containerOfElement);
...
EDQ.DataQuality.Address.Client = function Client(configurations) {
  ...
  for (var key in promptset.EDQFieldsMetadata) {
    ...
    for (var internalKeys in items) {
      ...
      promptset.EDQFieldsMetadata[key].Items[internalKeys].Html =
        promptset._loadHtmlElementMessages(item.Html);
      promptset.EDQFieldsMetadata[key].Items[internalKeys].Label =
        promptset._loadLabelMessages(item.Label);
    }
  }
};
EDQ.system.inherit(EDQ.DataQuality.Address.Client, EDQ.DataQuality.Client);

EDQ.DataQuality.Address.Client.prototype.createConfigurationsFor =
  function createConfigurationsFor(addressMappings) {
    var dq = EDQ.DataQuality;
    ...
    for (var i = 0; i < addressMappings.length; i++) {
      ...
      addressConfiguration.ServiceValidationTimeoutInMilliseconds =
        mappingJSON.ServiceValidationTimeoutInSeconds
          ? parseInt(mappingJSON.ServiceValidationTimeoutInSeconds) * 1000
          : 10000;
...
EDQ.DataQuality.Address.Client._getElementContainerDepth =
  function _getElementContainerDepth(element1Id, element2Id) {
    var client = EDQ.DataQuality.Client;
...
///////////////////////////////////////////////////
EDQ.DataQuality.Address.Client.prototype._initializeForConfiguration =
  function _initializeForConfiguration(configuration) {
    var sys = EDQ.system;
    var dq = EDQ.DataQuality;
    ...
    var dataSetElement =
      configuration._getElementFromInputMappingByEdqFieldName(dq.DataSet);
    ...
    var findAddressElement =
      configuration._getElementFromInputMappingByEdqFieldName(
    ...
    if (configuration.EnforceUsage && !sys.isNull(submitElement)) {
      ...
      if (
        submitElement.getAttribute('id') === 'edq-validation-button-billing'
      ) {
    ...
    if (configuration._injectInputMappingForInline) {
      var manualEntryElement =
        configuration._getElementFromInputMappingByEdqFieldName(dq.ManualEntry);
      ...
      var selectSuggestionButtonElement =
        configuration._getElementFromInputMappingByEdqFieldName(
          dq.SelectButton
        );
      dqClient._attachEvent(
        ...
        function () {
          try {
            client._selectAddress(
              ...
              configuration,
              function () {
                EDQ.DataQuality.Client.setProgress(
                  selectSuggestionButtonElement
                );
              },
              function () {
      ...
      var suggestionsElement =
        configuration._getElementFromInputMappingByEdqFieldName(dq.Suggestions);
      ...
      var refineElement =
        configuration._getElementFromInputMappingByEdqFieldName(dq.RefineInput);
      var tryAgainElement =
        configuration._getElementFromInputMappingByEdqFieldName(dq.TryAgain);
      ...
      var backButtonElement =
        configuration._getElementFromInputMappingByEdqFieldName(dq.BackButton);
      ...
      var nextButtonElement =
        configuration._getElementFromInputMappingByEdqFieldName(dq.NextButton);
...
EDQ.DataQuality.Address.Client.prototype._showPromptSetFor =
  function _showPromptSetFor(configuration, dataSet, unknownPostcode) {
    var sys = EDQ.system;
    var dq = EDQ.DataQuality;
    var promptset = dq.Address.PromptSet;
...
EDQ.DataQuality.Address.Client.prototype._showManualEntryFor =
  function _showManualEntryFor(configuration, showFindAddressButton) {
    var sys = EDQ.system;
    var dq = EDQ.DataQuality;
    var visibleElements = [];
...
EDQ.DataQuality.Address.Client.prototype._configurePromptSetElements =
  function _configurePromptSetElements(edqFieldsMetadata, configuration) {
    var sys = EDQ.system;
...
EDQ.DataQuality.Address.Client.prototype._showSuggestionsProptset =
  function _showSuggestionsProptset(configuration) {
    var dq = EDQ.DataQuality;
...
EDQ.DataQuality.Address.Client.prototype._showRefineInputPromptSet =
  function _showRefineInputPromptSet(configuration) {
    var dq = EDQ.DataQuality;
...
EDQ.DataQuality.Address.Client.prototype._showVerifiedAddressPromptSet =
  function _showVerifiedAddressPromptSet(configuration, dataSetSettings) {
    var sys = EDQ.system;
    var dq = EDQ.DataQuality;
...
EDQ.DataQuality.Address.Client.prototype._isUnknownPostcodePromptSet =
  function _isUnknownPostcodePromptSet(configuration) {
    var sys = EDQ.system;
    var dq = EDQ.DataQuality;
    var client = EDQ.DataQuality.Client;
    ...
    var knownPostCodeElementIds =
      configuration._inputMappings[dq.KnownPostCode];
    if (
...
EDQ.DataQuality.Address.Client.prototype._refineAddress =
  function _refineAddress(
    dataSet,
    refineInput,
    configuration,
    beforeExecuteCallback,
...
EDQ.DataQuality.Address.Client.prototype._executeRefineAddress =
  function _executeRefineAddress(
    dataSet,
    moniker,
    refineInput,
    configuration,
...
EDQ.DataQuality.Address.Client.prototype._validateRefinementInput =
  function _validateRefinementInput(
    refineInput,
    partialAddress,
    unresolvableRange
  ) {
...
EDQ.DataQuality.Address.Client.prototype._executeFindAddressRequest =
  function _executeFindAddressRequest(
    configuration,
    dataSet,
    parameters,
    url,
    ...
    var response = {
      PickListEntries: [
        {
          Moniker:
            'USA|14303cd7-5fca-4875-bbc0-8bfcac1d310d|7.730aOUSADwjmBwAAAAAEAwEAAAAFu7N6EgghmQIAAAAAAAAAAAD..0YAAAAA.....wAAAAAAAAAACAAgAAEAAgAAAERpc25leSBTdG9yZQAAAABEaXNuZXkgU3RvcmUgMTU0MCBCcm9hZHdheSxOZXcgWW9yayxOWSwxMDAzNgAAAAAA$44',
          PartialAddress: 'Disney Store, 1540 Broadway, New York NY 10036-4039',
          PickList: '1540 Broadway, New York NY',
          Postcode: '10036-4039',
          Score: '70',
          FullAddress: true,
        ...
        {
          Moniker:
            'USA|14303cd7-5fca-4875-bbc0-8bfcac1d310d|7.730QOUSADwjmBwAAAAAEAwEAAAAFu7OlkAghIIIZkCAAAAAAAAAAAP..RgAAAAD.....AAAAAAAAAAAIACAAAQACAAAARGlzbmV5IFN0b3JlAAAAAERpc25leSBTdG9yZSAxNTQwIEJyb2Fkd2F5LE5ldyBZb3JrLE5ZLDEwMDM2AAAAAAA-$44',
          PartialAddress:
            'Disney Store, 1540 Broadway Fl 4, New York NY 10036-4112',
          PickList: '1540 Broadway Fl 4, New York NY',
          Postcode: '10036-4112',
          Score: '70',
          FullAddress: true,
          UnresolvableRange: false,
        ...
        {
          Moniker:
            'USA|14303cd7-5fca-4875-bbc0-8bfcac1d310d|7.730ZOUSADwjmBwAAAAAEAwEAAAAFu7OCkAghIIIZkCAAAAAAAAAAAP..RgAAAAD.....AAAAAAAAAAAIACAAAQACAAAARGlzbmV5IFN0b3JlAAAAAERpc25leSBTdG9yZSAxNTQwIEJyb2Fkd2F5LE5ldyBZb3JrLE5ZLDEwMDM2AAAAAAA-$44',
          PartialAddress:
            'Disney Store, 1540 Broadway Fl 8, New York NY 10036-4039',
          PickList: '1540 Broadway Fl 8, New York NY',
          Postcode: '10036-4039',
          Score: '70',
          FullAddress: true,
          UnresolvableRange: false,
        ...
        {
          Moniker:
            'USA|14303cd7-5fca-4875-bbc0-8bfcac1d310d|7.730_OUSADwjmBwAAAAAEAwEAAAAFu7OVkAghIIIZkCAAAAAAAAAAAP..RgAAAAD.....AAAAAAAAAAAIACAAAQACAAAARGlzbmV5IFN0b3JlAAAAAERpc25leSBTdG9yZSAxNTQwIEJyb2Fkd2F5LE5ldyBZb3JrLE5ZLDEwMDM2AAAAAAA-$44',
          PartialAddress:
            'Disney Store, 1540 Broadway Fl 9, New York NY 10036-4083',
          PickList: '1540 Broadway Fl 9, New York NY',
          Postcode: '10036-4083',
          Score: '70',
          FullAddress: true,
          UnresolvableRange: false,
        ...
        {
          Moniker:
            'USA|14303cd7-5fca-4875-bbc0-8bfcac1d310d|7.7303OUSADwjmBwAAAAAEAwEAAAAFu7KoUAghmQIAAAAAAAAAAAD..0YAAAAA.....wAAAAAAAAAACAAgAAEAAgAAAERpc25leSBTdG9yZQAAAABEaXNuZXkgU3RvcmUgMTU0MCBCcm9hZHdheSxOZXcgWW9yayxOWSwxMDAzNgAAAAAA$44',
          PartialAddress:
            'Disney Store, 1540 Broadway Fl 11, New York NY 10036-4039',
          PickList: '1540 Broadway Fl 11, New York NY',
          Postcode: '10036-4039',
          Score: '70',
          FullAddress: true,
          UnresolvableRange: false,
        ...
        {
          Moniker:
            'USA|14303cd7-5fca-4875-bbc0-8bfcac1d310d|7.730qOUSADwjmBwAAAAAEAwEAAAAFu7N60gghmQIAAAAAAAAAAAD..0YAAAAA.....wAAAAAAAAAACAAgAAEAAgAAAERpc25leSBTdG9yZQAAAABEaXNuZXkgU3RvcmUgMTU0MCBCcm9hZHdheSxOZXcgWW9yayxOWSwxMDAzNgAAAAAA$44',
          PartialAddress:
            'Disney Store, 1540 Broadway Fl 12 ... 24, New York NY 10036-4039',
          PickList: '1540 Broadway Fl 12 ... 24, New York NY',
          Postcode: '10036-4039',
          Score: '70',
          FullAddress: false,
        ...
        {
          Moniker:
            'USA|14303cd7-5fca-4875-bbc0-8bfcac1d310d|7.730KOUSADwjmBwAAAAAEAwEAAAAFu7Ow0AghIIIZkCAAAAAAAAAAAP..RgAAAAD.....AAAAAAAAAAAIACAAAQACAAAARGlzbmV5IFN0b3JlAAAAAERpc25leSBTdG9yZSAxNTQwIEJyb2Fkd2F5LE5ldyBZb3JrLE5ZLDEwMDM2AAAAAAA-$44',
          PartialAddress:
            'Disney Store, 1540 Broadway Fl 12, New York NY 10036-4086',
          PickList: '1540 Broadway Fl 12, New York NY',
          Postcode: '10036-4086',
          Score: '70',
          FullAddress: true,
          UnresolvableRange: false,
        ...
        {
          Moniker:
            'USA|14303cd7-5fca-4875-bbc0-8bfcac1d310d|7.730cOUSADwjmBwAAAAAEAwEAAAAFu7OxkAghIIIRACGZAgAAAAAAAAAAAP..RgAAAAD.....AAAAAAAAAAAIACAAAQACAAAARGlzbmV5IFN0b3JlAAAAAERpc25leSBTdG9yZSAxNTQwIEJyb2Fkd2F5LE5ldyBZb3JrLE5ZLDEwMDM2AAAAAAA-$44',
          PartialAddress:
            'Duane Morris Llc Disney Store, 1540 Broadway Fl 12, New York NY 10036-4086',
          PickList: 'Duane Morris Llc, 1540 Broadway Fl 12, New York NY',
          Postcode: '10036-4086',
          Score: '70',
          FullAddress: true,
          UnresolvableRange: false,
        ...
        {
          Moniker:
            'USA|14303cd7-5fca-4875-bbc0-8bfcac1d310d|7.730ZOUSADwjmBwAAAAAEAwEAAAAFu7KpUAghmQIAAAAAAAAAAAD..0YAAAAA.....wAAAAAAAAAACAAgAAEAAgAAAERpc25leSBTdG9yZQAAAABEaXNuZXkgU3RvcmUgMTU0MCBCcm9hZHdheSxOZXcgWW9yayxOWSwxMDAzNgAAAAAA$44',
          PartialAddress:
            'Disney Store, 1540 Broadway Fl 14, New York NY 10036-4039',
          PickList: '1540 Broadway Fl 14, New York NY',
          Postcode: '10036-4039',
          Score: '70',
          FullAddress: true,
          UnresolvableRange: false,
        ...
        {
          Moniker:
            'USA|14303cd7-5fca-4875-bbc0-8bfcac1d310d|7.7301OUSADwjmBwAAAAAEAwEAAAAFu7Kv0AghmQIAAAAAAAAAAAD..0YAAAAA.....wAAAAAAAAAACAAgAAEAAgAAAERpc25leSBTdG9yZQAAAABEaXNuZXkgU3RvcmUgMTU0MCBCcm9hZHdheSxOZXcgWW9yayxOWSwxMDAzNgAAAAAA$44',
          PartialAddress:
            'Disney Store, 1540 Broadway Fl 18, New York NY 10036-4083',
          PickList: '1540 Broadway Fl 18, New York NY',
          Postcode: '10036-4083',
          Score: '70',
          FullAddress: true,
          UnresolvableRange: false,
        ...
        {
          Moniker:
            'USA|14303cd7-5fca-4875-bbc0-8bfcac1d310d|7.730oOUSADwjmBwAAAAAEAwEAAAAFu7Kw0AghmQIAAAAAAAAAAAD..0YAAAAA.....wAAAAAAAAAACAAgAAEAAgAAAERpc25leSBTdG9yZQAAAABEaXNuZXkgU3RvcmUgMTU0MCBCcm9hZHdheSxOZXcgWW9yayxOWSwxMDAzNgAAAAAA$44',
          PartialAddress:
            'Disney Store, 1540 Broadway Fl 19, New York NY 10036-4083',
          PickList: '1540 Broadway Fl 19, New York NY',
          Postcode: '10036-4083',
          Score: '70',
          FullAddress: true,
          UnresolvableRange: false,
        ...
        {
          Moniker:
            'USA|14303cd7-5fca-4875-bbc0-8bfcac1d310d|7.730ROUSADwjmBwAAAAAEAwEAAAAFu7Kx0AghmQIAAAAAAAAAAAD..0YAAAAA.....wAAAAAAAAAACAAgAAEAAgAAAERpc25leSBTdG9yZQAAAABEaXNuZXkgU3RvcmUgMTU0MCBCcm9hZHdheSxOZXcgWW9yayxOWSwxMDAzNgAAAAAA$44',
          PartialAddress:
            'Disney Store, 1540 Broadway Fl 20, New York NY 10036-4083',
          PickList: '1540 Broadway Fl 20, New York NY',
          Postcode: '10036-4083',
          Score: '70',
          FullAddress: true,
          UnresolvableRange: false,
        ...
        {
          Moniker:
            'USA|14303cd7-5fca-4875-bbc0-8bfcac1d310d|7.730MOUSADwjmBwAAAAAEAwEAAAAFu7Ky0AghmQIAAAAAAAAAAAD..0YAAAAA.....wAAAAAAAAAACAAgAAEAAgAAAERpc25leSBTdG9yZQAAAABEaXNuZXkgU3RvcmUgMTU0MCBCcm9hZHdheSxOZXcgWW9yayxOWSwxMDAzNgAAAAAA$44',
          PartialAddress:
            'Disney Store, 1540 Broadway Fl 21, New York NY 10036-4083',
          PickList: '1540 Broadway Fl 21, New York NY',
          Postcode: '10036-4083',
          Score: '70',
          FullAddress: true,
          UnresolvableRange: false,
        ...
        {
          Moniker:
            'USA|14303cd7-5fca-4875-bbc0-8bfcac1d310d|7.730rOUSADwjmBwAAAAAEAwEAAAAFu7Kz0AghmQIAAAAAAAAAAAD..0YAAAAA.....wAAAAAAAAAACAAgAAEAAgAAAERpc25leSBTdG9yZQAAAABEaXNuZXkgU3RvcmUgMTU0MCBCcm9hZHdheSxOZXcgWW9yayxOWSwxMDAzNgAAAAAA$44',
          PartialAddress:
            'Disney Store, 1540 Broadway Fl 22, New York NY 10036-4083',
          PickList: '1540 Broadway Fl 22, New York NY',
          Postcode: '10036-4083',
          Score: '70',
          FullAddress: true,
          UnresolvableRange: false,
        ...
        {
          Moniker:
            'USA|14303cd7-5fca-4875-bbc0-8bfcac1d310d|7.730BOUSADwjmBwAAAAAEAwEAAAAFu7OtkAghIIIZkCAAAAAAAAAAAP..RgAAAAD.....AAAAAAAAAAAIACAAAQACAAAARGlzbmV5IFN0b3JlAAAAAERpc25leSBTdG9yZSAxNTQwIEJyb2Fkd2F5LE5ldyBZb3JrLE5ZLDEwMDM2AAAAAAA-$44',
          PartialAddress:
            'Disney Store, 1540 Broadway Fl 26, New York NY 10036-5013',
          PickList: '1540 Broadway Fl 26, New York NY',
          Postcode: '10036-5013',
          Score: '70',
          FullAddress: true,
          UnresolvableRange: false,
        ...
        {
          Moniker:
            'USA|14303cd7-5fca-4875-bbc0-8bfcac1d310d|7.730tOUSADwjmBwAAAAAEAwEAAAAFu7N8UgghmQIAAAAAAAAAAAD..0YAAAAA.....wAAAAAAAAAACAAgAAEAAgAAAERpc25leSBTdG9yZQAAAABEaXNuZXkgU3RvcmUgMTU0MCBCcm9hZHdheSxOZXcgWW9yayxOWSwxMDAzNgAAAAAA$44',
          PartialAddress:
            'Disney Store, 1540 Broadway Fl 27 ... 44, New York NY 10036-4039',
          PickList: '1540 Broadway Fl 27 ... 44, New York NY',
          Postcode: '10036-4039',
          Score: '70',
          FullAddress: false,
          UnresolvableRange: true,
        ...
        {
          Moniker:
            'USA|14303cd7-5fca-4875-bbc0-8bfcac1d310d|7.730gOUSADwjmBwAAAAAEAwEAAAAFu7K4EAghmQIAAAAAAAAAAAD..0YAAAAA.....wAAAAAAAAAACAAgAAEAAgAAAERpc25leSBTdG9yZQAAAABEaXNuZXkgU3RvcmUgMTU0MCBCcm9hZHdheSxOZXcgWW9yayxOWSwxMDAzNgAAAAAA$44',
          PartialAddress:
            'Disney Store, 1540 Broadway Fl 28, New York NY 10036-5013',
          PickList: '1540 Broadway Fl 28, New York NY',
          Postcode: '10036-5013',
          Score: '70',
          FullAddress: true,
          UnresolvableRange: false,
        ...
        {
          Moniker:
            'USA|14303cd7-5fca-4875-bbc0-8bfcac1d310d|7.7309OUSADwjmBwAAAAAEAwEAAAAFu7K5EAghmQIAAAAAAAAAAAD..0YAAAAA.....wAAAAAAAAAACAAgAAEAAgAAAERpc25leSBTdG9yZQAAAABEaXNuZXkgU3RvcmUgMTU0MCBCcm9hZHdheSxOZXcgWW9yayxOWSwxMDAzNgAAAAAA$44',
          PartialAddress:
            'Disney Store, 1540 Broadway Fl 29, New York NY 10036-5013',
          PickList: '1540 Broadway Fl 29, New York NY',
          Postcode: '10036-5013',
          Score: '70',
          FullAddress: true,
          UnresolvableRange: false,
        ...
        {
          Moniker:
            'USA|14303cd7-5fca-4875-bbc0-8bfcac1d310d|7.730aOUSADwjmBwAAAAAEAwEAAAAFu7K6EAghmQIAAAAAAAAAAAD..0YAAAAA.....wAAAAAAAAAACAAgAAEAAgAAAERpc25leSBTdG9yZQAAAABEaXNuZXkgU3RvcmUgMTU0MCBCcm9hZHdheSxOZXcgWW9yayxOWSwxMDAzNgAAAAAA$44',
          PartialAddress:
            'Disney Store, 1540 Broadway Fl 30, New York NY 10036-5013',
          PickList: '1540 Broadway Fl 30, New York NY',
          Postcode: '10036-5013',
          Score: '70',
          FullAddress: true,
          UnresolvableRange: false,
        ...
        {
          Moniker:
            'USA|14303cd7-5fca-4875-bbc0-8bfcac1d310d|7.730HOUSADwjmBwAAAAAEAwEAAAAFu7K7EAghmQIAAAAAAAAAAAD..0YAAAAA.....wAAAAAAAAAACAAgAAEAAgAAAERpc25leSBTdG9yZQAAAABEaXNuZXkgU3RvcmUgMTU0MCBCcm9hZHdheSxOZXcgWW9yayxOWSwxMDAzNgAAAAAA$44',
          PartialAddress:
            'Disney Store, 1540 Broadway Fl 31, New York NY 10036-5013',
          PickList: '1540 Broadway Fl 31, New York NY',
          Postcode: '10036-5013',
          Score: '70',
          FullAddress: true,
          UnresolvableRange: false,
        ...
        {
          Moniker:
            'USA|14303cd7-5fca-4875-bbc0-8bfcac1d310d|7.730_OUSADwjmBwAAAAAEAwEAAAAFu7K8EAghmQIAAAAAAAAAAAD..0YAAAAA.....wAAAAAAAAAACAAgAAEAAgAAAERpc25leSBTdG9yZQAAAABEaXNuZXkgU3RvcmUgMTU0MCBCcm9hZHdheSxOZXcgWW9yayxOWSwxMDAzNgAAAAAA$44',
          PartialAddress:
            'Disney Store, 1540 Broadway Fl 32, New York NY 10036-5013',
          PickList: '1540 Broadway Fl 32, New York NY',
          Postcode: '10036-5013',
          Score: '70',
          FullAddress: true,
          UnresolvableRange: false,
        ...
        {
          Moniker:
            'USA|14303cd7-5fca-4875-bbc0-8bfcac1d310d|7.730jOUSADwjmBwAAAAAEAwEAAAAFu7K9EAghmQIAAAAAAAAAAAD..0YAAAAA.....wAAAAAAAAAACAAgAAEAAgAAAERpc25leSBTdG9yZQAAAABEaXNuZXkgU3RvcmUgMTU0MCBCcm9hZHdheSxOZXcgWW9yayxOWSwxMDAzNgAAAAAA$44',
          PartialAddress:
            'Disney Store, 1540 Broadway Fl 33, New York NY 10036-5013',
          PickList: '1540 Broadway Fl 33, New York NY',
          Postcode: '10036-5013',
          Score: '70',
          FullAddress: true,
          UnresolvableRange: false,
        ...
        {
          Moniker:
            'USA|14303cd7-5fca-4875-bbc0-8bfcac1d310d|7.730cOUSADwjmBwAAAAAEAwEAAAAFu7K_EAghmQIAAAAAAAAAAAD..0YAAAAA.....wAAAAAAAAAACAAgAAEAAgAAAERpc25leSBTdG9yZQAAAABEaXNuZXkgU3RvcmUgMTU0MCBCcm9hZHdheSxOZXcgWW9yayxOWSwxMDAzNgAAAAAA$44',
          PartialAddress:
            'Disney Store, 1540 Broadway Fl 35, New York NY 10036-5013',
          PickList: '1540 Broadway Fl 35, New York NY',
          Postcode: '10036-5013',
          Score: '70',
          FullAddress: true,
          UnresolvableRange: false,
        ...
        {
          Moniker:
            'USA|14303cd7-5fca-4875-bbc0-8bfcac1d310d|7.730GOUSADwjmBwAAAAAEAwEAAAAFu7ORkAghIIIZkCAAAAAAAAAAAP..RgAAAAD.....AAAAAAAAAAAIACAAAQACAAAARGlzbmV5IFN0b3JlAAAAAERpc25leSBTdG9yZSAxNTQwIEJyb2Fkd2F5LE5ldyBZb3JrLE5ZLDEwMDM2AAAAAAA-$44',
          PartialAddress:
            'Disney Store, 1540 Broadway Frnt 1, New York NY 10036-4081',
          PickList: '1540 Broadway Frnt 1, New York NY',
          Postcode: '10036-4081',
          Score: '70',
          FullAddress: true,
          UnresolvableRange: false,
        ...
        {
          Moniker:
            'USA|14303cd7-5fca-4875-bbc0-8bfcac1d310d|7.730xOUSADwjmBwAAAAAEAwEAAAAFu7OZEAghIIIZkCAAAAAAAAAAAP..RgAAAAD.....AAAAAAAAAAAIACAAAQACAAAARGlzbmV5IFN0b3JlAAAAAERpc25leSBTdG9yZSAxNTQwIEJyb2Fkd2F5LE5ldyBZb3JrLE5ZLDEwMDM2AAAAAAA-$44',
          PartialAddress:
            'Disney Store, 1540 Broadway Frnt 2, New York NY 10036-4093',
          PickList: '1540 Broadway Frnt 2, New York NY',
          Postcode: '10036-4093',
          Score: '70',
          FullAddress: true,
          UnresolvableRange: false,
      ...
      Total: '25',
      isAutoStepinSafe: false,
      FullPicklistMoniker:
        'USA|14303cd7-5fca-4875-bbc0-8bfcac1d310d|7.7300SUSADwjmBwAAAAAEAURpc25leSBTdG9yZSAxNTQwIEJyb2Fkd2F5LE5ldyBZb3JrLE5ZLDEwMDM2ACoDAAA-$44',
      total: '25',
      prompt: 'Please choose from the options below',
      pickListEntries: [
        {
      ...
      verificationLevel: 'Multiple',
      autoStepinSafe: false,
      fullPicklistMoniker:
        'USA|14303cd7-5fca-4875-bbc0-8bfcac1d310d|7.7300SUSADwjmBwAAAAAEAURpc25leSBTdG9yZSAxNTQwIEJyb2Fkd2F5LE5ldyBZb3JrLE5ZLDEwMDM2ACoDAAA-$44',
      validationStatus: null,
      addressLineDictionary: null,
    ...
    if (useModal) {
      ...
      if (isSearchOperation) {
        if (response.verificationLevel === dq.AddressVerifyLevels.NONE) {
          ...
          var suggestionsElementLabel =
            configuration._getElementLabelFromInputMappingByEdqFieldName(
              dq.Suggestions
            );
    ...
    //             } else {
    //               var result =
    //                 dq.Address.Client._expandValidationResult(response);
    //               client.setValues(dataSet, result, configuration);
    //               if (onFinishCallback) onFinishCallback();
...
EDQ.DataQuality.Address.Client.prototype.getVerifyLevel =
  function getVerifyLevel(response) {
    if (
      response.verificationLevel ===
      EDQ.DataQuality.AddressVerifyLevels.VERIFIED
    ) {
...
EDQ.DataQuality.Address.Client.populateSuggestionList =
  function populateSuggestionList(suggestionsElement, response) {
...
EDQ.DataQuality.Address.Client.prototype._selectAddress =
...
EDQ.DataQuality.Address.Client._expandValidationResult =
  function _expandValidationResult(validationResultJson) {
    var sys = EDQ.system;
...
EDQ.DataQuality.Address.Client.prototype._promptSetForErrorMessage =
  function _promptSetForErrorMessage(
    errorMessage,
    configuration,
    response,
    dataset
...
EDQ.DataQuality.Address.Client.prototype._showErrorMessage =
  function _showErrorMessage(message, configuration) {
    var sys = EDQ.system;
    var dq = EDQ.DataQuality;
...
EDQ.DataQuality.Address.Client.prototype._getDataSetFromConfiguration =
  function _getDataSetFromConfiguration(configuration) {
    var sys = EDQ.system;
    var dq = EDQ.DataQuality;
...
EDQ.DataQuality.Address.Client._getDataSetByCountry =
  function _getDataSetByCountry(country) {
    var addressClient = EDQ.DataQuality.Address.Client;
    var sys = EDQ.system;
...
EDQ.DataQuality.Address.Client.prototype._getDataSetSettings =
  function _getDataSetSettings(dataSet) {
    var addressClient = EDQ.DataQuality.Address.Client;
    var sys = EDQ.system;
...
EDQ.DataQuality.Address.PromptSet._getConfiguration =
  function _getConfiguration(dataset) {
    var promptset = EDQ.DataQuality.Address.PromptSet;
...
EDQ.DataQuality.Address.PromptSet._loadLabelMessages =
  function _loadLabelMessages(message) {
    var sys = EDQ.system;
    ...
    if (
      ...
      return EDQ.DataQuality.Address.PromptSet.EDQFieldsMetadataMessages[
        message
      ];
    } else {
      return message;
...
EDQ.DataQuality.Address.PromptSet._loadHtmlElementMessages =
  function _loadHtmlElementMessages(html) {
    var sys = EDQ.system;
    try {
...
EDQ.DataQuality.EmailPhone.processValidationResult =
...
EDQ.DataQuality.EmailPhone._expandValidationResult =
  function _expandValidationResult(
    validationResultJson,
    resultCodeToDescription,
    configuration
  ) {
...
EDQ.DataQuality.Phone.Client.prototype._initializeForConfiguration =
  function _initializeForConfiguration(configuration) {
    var sys = EDQ.system;
    var dq = EDQ.DataQuality;
    var dqClient = EDQ.DataQuality.Client;
    ...
    var phoneNumberElement =
      configuration._getElementFromInputMappingByEdqFieldName(dq.Number);
    ...
    var phoneAreaCodeElement =
      configuration._getElementFromInputMappingByEdqFieldName(dq.AreaCode);
...
EDQ.DataQuality.Phone.Client.prototype.isEdqFieldNameSetValueAllowedForValidationStatus =
  function isEdqFieldNameSetValueAllowedForValidationStatus(
    edqFieldName,
    validationStatus
  ) {
...
EDQ.DataQuality.Email.Client.prototype._initializeForConfiguration =
  function _initializeForConfiguration(configuration) {
    var sys = EDQ.system;
    var dq = EDQ.DataQuality;
    var dqClient = EDQ.DataQuality.Client;
    ...
    dqClient._attachEvent(emailElement, 'onblur', function (event) {
      ...
      if (
        client._callOnValidationStart(configuration, emailElement) === false
      ) {
        return;
      }
...
EDQ.DataQuality.Email.Client.prototype.isEdqFieldNameSetValueAllowedForValidationStatus =
  function isEdqFieldNameSetValueAllowedForValidationStatus(
    edqFieldName,
    validationStatus
  ) {
...
EDQ.DataQuality.Address.Modal = function Modal(editCall) {
  ...
  var buildInteractionRequired = function (
    ...
    var outputMapping = (datasetSettings =
      configuration.getDataSetSettings(dataset));
...
window.configureEDQ = function () {
  ...
  var result = {
    enableSignInViaGoogleForRecognizedUser: true,
    enableMemoryCaching: true,
    enablePasswordStrengthValidation: true,
    enablePerfProgressiveLoading: {
      footer: 'true',
      pdpBloomreachProgressiveLoading: 'true',
      pdp: 'true',
      pdpRecomprodProgressiveLoading: 'true',
      plpTileprodProgressiveLoading: 'true',
      bloomreachProgressiveLoading: 'true',
    },
    enableProductFlavorSizeBoxesUpgrade: true,
    enableQuantityLimiter: true,
    healthyAwardsMessageToggle: false,
    plpEnhancementMultiVariantLayout: '6VOV_hSmSIGVam35NzHrMw',
    enableEmailSignUpFeature: true,
    headerSummarySplitToggle: true,
    optimizelyBelowTheFoldPDP: '',
    cmsServicesBaseUrl: 'https://browse.vitaminshoppe.com/cms/content',
    enableCustomerAcquisitionFeature: false,
    merchantId: '0c32eb96edde11e4a938bc764e106cf4',
    enableSideChat: false,
    hideBeTheFirstToReviewOnPlpWithNoStars: 'false',
    hideCpcmOnPlpForMobile: 'false',
    mealPlanToggle: true,
    showExcludedItemsInOrderDiscount: true,
    hideCurbsideMsgOnCart: true,
    enableMITFeature: true,
    enableOurRecommendationUpgrade: false,
    enableDataLayerForDDB: true,
    enableTopNavNameVariantForSuperFood: 'false',
    bloomreachAccountId: '6139',
    enableJDAVoucherValidation: true,
    enableWriteOnTurnToReviews: true,
    enableTopNavNameVariantForNew: 'false',
    enableMixedCartFeature: true,
    enableHidePaymentSection: true,
    brVariants: '',
    orderValueBasedFreeShippingMessageOptimizely: '',
    cartUpdateDebounceTime: 500,
    discontinuedItemRedesign: true,
    enableReorderEnhancements: true,
    adpEnrolledOptionPDP: true,
    showFanreelImgInPdpSlider: true,
    enableDeliveryFeeForColoradoState: false,
    bloomreachAccountAuthorization: 'j7wa9y4bxuayn042',
    enableAddToCartIntercept: 'false',
    enableTurnToLogging: true,
    rrPreset: true,
    enableSignInViaGoogleForCheckoutWithADP: true,
    optimizelyAddToCartModal: '',
    enableFooterRedesign: true,
    enableKlarnaPaymentOption: true,
    enableSignInViaGoogleForMSI: true,
    disableWellnessDiscountCheckbox: false,
    loginModalToggle: false,
    removeVideoForHolidays: true,
    enableBloomReachSearchExperience: true,
    googlePayGatewayMerchantId: '22941486306103042',
    listOfSecuredPageUrls: [
      '/s/orderhistory/orderDetails.jsp',
      '/s/myAccount/myWishList.jsp',
      '/s/checkout/thankYou.jsp',
      '/u/buy-gift-card.jsp',
      '/cart/cart.jsp',
      '/cart/shopping-cart',
    ],
    enableEmailVerificationOnRegistration: false,
    storelocator: '//content.vitaminshoppe.com/storelocator',
    enablePathwaysRecsForItemSubs: true,
    enableGatedPage: false,
    edqEnableCountryMap: {
      US: 'USA',
      EUA: 'USA',
      USA: 'USA',
    ...
    notifyMePDPVerbiage:
      "By opting in to Notify Me alerts, you've consented to receiving marketing communications including information about the Healthy Awards® program.",
    enablePlpPaginationUpgrade: true,
    enableApplePayFeature: true,
    cartQtyCountersDelay: 1000,
    enableReplacementReOrderToSignInIcon: 'true',
    enableImpulseUpsellRestrictions: true,
    enableShippingChangeOnMSI: true,
    enableBreadCrumbsUpgrade: true,
    enableTopNavNameVariantForHerbsAndNR: 'true',
    removeShippingChargeMsg: false,
    enableDeliveryFiltersOnPlp: true,
    freeShippingTooltipMsg:
      'Orders for states outside of the continental U.S. may be subject to a delivery surcharge.',
    geoEmergencyBannerEnabled: true,
    enableClosedHourCheckForStore: true,
    optimizelyShowVariantPromoFlags: '',
    bloomReachPathwaysRecsBaseUrl:
      'https://browse.vitaminshoppe.com/rec/recommendation/pathwaysAndRecs',
    enablePasswordReminder: true,
    turnToSiteKey: 'I1h5bZdr3OSP4fMsite',
    enableLoyaltyForAllCustomers: true,
    freeShippingPromoAmt: 25,
    impulseOfferIdForRR: '88ace274552611e78a2abc764e106cf4',
    skipPDPUrlConstruction: true,
    discontinuedPDPVerbiage:
      "<div class='disco-msg--col'><div class='disco-msg--row disco-msg--one'><span class='disco-msg--one-text'>This product is Discontinued.</span></div><div class='disco-msg--row disco-msg--two'><span class='disco-msg--two-text'>Consider these available products.&nbsp;</span><a href='javascript:void(0)' class='disco-msg--ch-link' ng-click='onClickDiscontinuedMsgLink()'><span class='disco-msg--ch-link-text'>Click Here.</span></a></div></div>",
    newFreeShippingPromoAmt: 49,
    msiUrl:
      'https://static.ordergroove.com/0c32eb96edde11e4a938bc764e106cf4/msi.js',
    ng8UpgradeMyAccountToggles: {
      enableMyAccountEditProfileOverlayUpgrade: 'false',
      enableMyAccountAddShippingAddressOverleyUpgrade: 'false',
      enableMyAccountPaymentMethodUpgrade: 'true',
      enableMyAccountNutritionCoachingUpgrade: 'true',
      enableMyAccountEditBillingAddressOverleyUpgrade: 'false',
      enableMyAccountPasswordAndSecurityUpgrade: 'true',
      enableMyAccountUpdatePasswordOverleyUpgrade: 'false',
      enableMyAccountProfileDetailsUpgrade: 'false',
      enableMyAccountProfileUpgrade: 'true',
      enableMyAccountAddANewCreditCardOverlayUpgrade: 'true',
      enableMyAccountEditPaymentMethodOverlayUpgrade: 'true',
      enableMyAccountAutoDeliveryUpgrade: 'true',
      enableMyAccountShippingAddressUpgrade: 'true',
      enableMyAccountBillingAddressUpgrade: 'true',
      enableMyAccountPurchaseHistoryContainerUpgrade: 'false',
      enableMyAccountProfileBreadCrumbsUpgrade: 'true',
      enableMyAccountHealthyAwardsUpgrade: 'true',
      enableMyAccountViewEditProfileUpgrade: 'false',
      enableMyAccountManageMyAwardsUpgrade: 'true',
      enableMyAccountEditShippingAddressOverleyUpgrade: 'false',
    },
    enableBloomreach: true,
    enableSeeAllForMobileView: false,
    passwordRemindByPage: {
      myAccount: 'true',
      purchaseHistory: 'true',
      msi: 'true',
    },
    enablePdpAutoDeliveryUpdate: true,
    bopsEnabled: true,
    optimizelyDoubleExposeMobilePDPPrice: '',
    plpEnhancementPricingLayout: 'true',
    enableRiskifiedFraudCheck: true,
    ng8UpgradePDPToggles: {
      enableOgInfoOverlayUpgrade: 'true',
      enablePdpMainProductDetailsUpgrade: 'true',
      enablePdpVitaminAngelsUpgrade: 'true',
      enablePdpProductInfoUpgrade: 'true',
      enablePdpSocialEngagedUpgrade: 'true',
    },
    enableAdpTemplateBopusFeature: true,
    turnToSpeedFlexSiteKey: 'I1h5bZdr3OSP4fMsite',
    bloomreachSearchEndpoint: 'search',
    enableDynamicCouponForAcquisition: true,
    enablePlpNg8Upgrade: false,
    enablePinchInZoom: true,
    enablePageNotFound: true,
    enableThankYouPagePurchaseEventLogging: true,
    enablePDPUpgradeReviewAndQuestionAnswer: true,
    enableTopNavNameVariantForHealthSolution: 'false',
    klarnaJsUrl: 'https://na-library.klarnaservices.com/lib.js',
    enablePdpMobileReduceSizeOfProductName: 'true',
    reorderWidgetFromPhoneNumber: '+1 (551) 227-9906',
    enablePDPUpgradePriceDetails: true,
    defaultBirthYear: '1904',
    enablePlpFilterSearchUpgrade: true,
    enableImageLcpElement: true,
    enableEmergencyBannerPerformance: {},
    removeBirthYear: true,
    enableSignInViaGoogleForTurnTo: true,
    enablePlpFilterListUpgrade: true,
    cmsIntegrationToggles: {
      enableHomePageFromCMS: 'true',
      enableLandingPageFromCMS: 'true',
    },
    pdpFreeShippingTooltipMsg:
      'Orders for states outside of the continental U.S. may be subject to a delivery surcharge.',
    enableImpulseUpsellInlineUpgrade: true,
    orderValueBasedFreeShippingMessageToggle: false,
    newBaseContentUrl: 'https://staging-browse.vitaminshoppe.com/product-aws/',
    bloomreachRefinementsEndpoint: 'search/refinements',
    itemSwapScreenRecommendedProductsLimit: 15,
    recaptchaConfig: {
      SiteKey2: '6Lc9KhoUAAAAANwF7CCUvbxpaLZC5PuYvMboh7Nc',
      SiteKey3: '6LeQCrEZAAAAALSQMoI8mizebbn5ZPpnjQ5BLz3P',
      enableCreateAccountRecaptcha: 'true',
      version: 'v3',
    },
    enableMobilePlpFilterEnhancement: 'true',
    newPdpUrl: '//staging-browse.vitaminshoppe.com/product-aws/pdp',
    applyADPDiscountedPrice: true,
    enableSingleReorderOptIn: true,
    enableHomePageModularUpgrade: true,
    enableAurusTemplateIdChange: true,
    enableCJServerSideCookie: true,
    isRectifyURLToggle: false,
    richRelevanceMyRec:
      'https://recs.richrelevance.com/rrserver/api/rrPlatform/myRecs?apiClientKey=a4e20b4d9cc0ee39&apiKey=3d1793d5639baeb9',
    enablePaypalForADPOrders: false,
    enableTurnToReview: true,
    adpReorderToggle: true,
    optimizelyPLPEnhancements: '17897910347,17911190407',
    hideSmsOptInFromProfileCompletionPage: true,
    utilityPageMediaMapping: {},
    enablePLPVariantsCount: true,
    relocatePDPThumbnails: 'true',
    qrwtihCRM: 'true',
    pdpinventory: '//content.vitaminshoppe.com/pdpinventory',
    enablePIMOnPdp: false,
    rectifyPDPURLToggle: true,
    msiImpulseUrl:
      'https://static.ordergroove.com/0c32eb96edde11e4a938bc764e106cf4/main',
    enableWebPageForWellness: true,
    optimizelyPDPRedesignS14: '',
    adpEnrolledOptionReorder: true,
    enableWellnessPartnerProgram: true,
    enableSkuRestrictionByAge: true,
    enableWellnessPartnerProgramEmail: true,
    enablePDPRedesignS14: false,
    cartQtyInputDelay: 1000,
    enableReusableBagOnCart: false,
    enableOnlineInterceptSurvey: 'false',
    showVitaminAngelsOnPDP: 'false',
    enablePDPRedesignS13: 'true',
    redesignHealthGoalsPLP: true,
    enableAmplience: false,
    klarnaMinEligibleAmount: 10,
    geoEmergencyBannerBaseUrl:
      'https://browse.vitaminshoppe.com/geobanner/data',
    enableCartRedesignDeliveryOption: 'false',
    enablePlpNoSearchContentUpgrade: true,
    optimizelyNthOrderPromoExperimentAndVariationId:
      '15836530278,15836740236,15860030271',
    enableImpulseSelling: true,
    siteWideBestSellers:
      'https://recs.richrelevance.com/rrserver/api/rrPlatform/recsUsingStrategy?apiClientKey=a4e20b4d9cc0ee39&apiKey=3d1793d5639baeb9&userId=',
    enableCartRedesignCartSummary: 'true',
    enableRepositionOfItemNumber: 'true',
    klarnaMaxEligibleAmount: 1000,
    enableSignInViaGoogleForMyAccount: true,
    bloomreachTypeAheadEndpoint: 'typeAhead',
    enableHomePageAPIResponseCaching: true,
    enableSmartImagingFeature: true,
    redesignForgotPassEmailConfirmation: true,
    displayCOMOrdersInPurchaseHistory: true,
    enablePDPUpgrade: false,
    impulseOfferIdForPDP: '6ad486a8552611e78a2abc764e106cf4',
    enableCartRedesignADP: 'true',
    enableSlimHeader: true,
    enableSignInViaGoogleForOrderHistory: true,
    adpMultipleRewardsPts: true,
    singleVariantABTest: 'rhJTcwTKQ0OUzEzpk2ceWA',
    enableGoogleSignInFeature: true,
    optimizelyVitaminAngelsOnPDP: '',
    enablePlpLevelOneHeadingUpgrade: true,
    enableHAOnBoardingExperience: false,
    enableReorderInCompleteProfile: true,
    enableOGSDKVersionUpgrade: false,
    enableGooglePayOnCart: true,
    enablePdpBreadCrumbsUpgrade: true,
    enableCopyToShippingForMSIPayment: true,
    enablePlpFilterSingleUpgrade: true,
    enableSignInViaGoogleForCheckout: true,
    enableExtoleFeature: false,
    displayAutoDeliveryAddressMessage: true,
    enableSaveForLaterFeature: false,
    enablePlpFilterValueUpgrade: true,
    removePencilBannerLink: false,
    enableTurnToSpeedFlexSSO: true,
    enablePDPUpgradeProductDetails: true,
    listOfURLToValidate: [
      '/rest/model/core/rest/customer/actor/VSICustomerActor/editContactInfo',
      '/rest/model/core/rest/customer/actor/VSICustomerActor/addContactInfo',
      '/rest/model/core/rest/customer/actor/VSICustomerActor/updateProfileWithSubscriptions',
      '/rest/model/atg/userprofiling/ProfileActor/removeAddress',
      '/u/global/gadgets/addBundleToCart.jsp',
      '/rest/model/core/rest/customer/actor/VSICustomerActor/updateProfile-response',
      '/rest/model/core/rest/commerce/actor/VSIShoppingCartActor/addOrderIdToSessionBean',
      '/rest/model/vitaminshoppe/web/actor/VSIWebShoppingCartActor/redeemDiscount',
      '/rest/model/vitaminshoppe/web/actor/VSIWebShoppingCartActor/changeDeliveryMethod',
      '/rest/model/vitaminshoppe/web/actor/VSIWebShoppingCartActor/checkOutNow',
      '/rest/model/vitaminshoppe/web/actor/VSIWebShoppingCartActor/removeItemFromOrder',
      '/rest/model/vitaminshoppe/web/actor/VSIWebShoppingCartActor/updateQuantity',
      '/rest/model/vitaminshoppe/web/actor/VSIWebShoppingCartActor/changeFrequency',
      '/rest/model/vitaminshoppe/commerce/reorder/addEditContactInfoForPotentialUser',
      '/rest/model/core/rest/notifyMe/actor/VSINotifyMeActor/saveNotifyMeRequest',
    ],
    enablePlpVictoryCategoryTreeUpgrade: true,
    adpFreeShippingToggle: false,
    cartRedesignSpinnerDelayTime: 500,
    doubleExposeMobilePDPPrice: false,
    lcpImgTimeout: 2000,
    hideCartUpdateCta: 'true',
    enablePDPUpgradeBloomReachWidgets: true,
    subscriptionBufferDays: 7,
    cmsMigratedLandingPages: [],
    virtualConsultantToggle: true,
    adpOptInToggle: true,
    enableHeroLevelThreeUpgrade: true,
    generateAndValidateToken: true,
    plpEnhancementReposDisclamerToolTip: true,
    enablePDPRedesignVariants: true,
    allowPaypalAsPreferredPaymentMethod: false,
    enable404Redirects: true,
    redesignAddToCartModal: true,
    enablePDPUpgradeDeliveryOption: true,
    showCustomerNumberInAccountDashboard: true,
    adpEnrolledOptionQuickView: true,
    enableBloomReachPathwaysRecs: true,
    enablePerfSkeletonLoader: {
      plp: 'false',
      pdp: 'false',
    },
    expandFirst3FacetsPLP: true,
    customerAcquisitionCouponExpirationLimit: 14,
    enableFlexibleShipping: true,
    enableThematicPage: true,
    enableTopNavUIFixForNameChange: true,
    enableTurnToUpgrade: true,
    enableOrderSummaryEnhancements: true,
    enableCartEnhancementPromoUIChange: true,
    disableHeaderFooterForApp: true,
    enableMyAccountLastOrderUpgrade: true,
    enableSearchSiteWideBanner: 'true',
    removePdpAdpModal: true,
    enablePlpNoProductsMsgUpdate: true,
    loginOGUrl:
      'https://static.ordergroove.com/0c32eb96edde11e4a938bc764e106cf4/login.js',
    reCaptchaKey: '6Lc9KhoUAAAAANwF7CCUvbxpaLZC5PuYvMboh7Nc',
    enableHomePageModularDesign: true,
    storeLocatorURL: 'https://locations.vitaminshoppe.com/',
    enableApplePayOnCart: true,
    turnToSpeedFlexAuthKey: 'DNTCJvO6a2vAWZxspeedflexupgdauth',
    enableDiscoveryDeliveryBoxFeature: false,
    enableTurnToUpgradeVShoppe: true,
    enableWebPreferredStore: true,
    enableAdpHAIntegration: true,
    enableRoktFeature: true,
    enableNotifyMe: true,
    enableGDPRForEUCustomers: true,
    enableAdpOnlyFeature: true,
    hideSmsOptInFromMyAccount: true,
    singleskumultistore: '//content.vitaminshoppe.com/singleskumultistore',
    enableProfileInfoForPotentialUser: true,
    klarnaWebClientId: '9c8532b4-15de-517f-bae8-e96279e099da',
    imageUrl: 'https://content.vitaminshoppe.com/img',
    bloomreachAPIHost: 'https://bsapi-e.brsrvr.com/v2/fetch_widget',
    restrictedStateLimitOnPdp: 10,
    nearbyStoresAvailMsg: 'Available in nearby stores',
    enablePDPMobileFlavoursReplacement: 'false',
    enableHidePlpFreeShippingMsg: 'false',
    enableHidePlpFreeInStorePickupMsg: 'false',
    baseContentUrl: 'https://content.vitaminshoppe.com/',
    enableReplacementReOrderToSignInIconFilled: 'true',
    signInViaGoogleClientID:
      '931504085674-f76eikscb47ilrro62rbnjus62jdu510.apps.googleusercontent.com',
    enableUpgradeMyAccountWishlist: true,
    enableTopHeaderEnhancement: false,
    enable3DigitZipcode: true,
    enableTurntoRedesign: true,
    bloomreachSearchBaseUrl: 'https://browse.vitaminshoppe.com/search/product/',
    hideShipToMeDeliveryMsgOnPdp: true,
    enableTopNavNameVariantForNaturalBeauty: 'false',
    enableBloomReachDarkLaunch: false,
    enablePlpSearchHeadingUpgrade: true,
    disableBOSTSFeature: true,
    enableSuperSupplementsOverlay: true,
    enablePlpMetaData: true,
    disableWellbeingWorkShop: true,
    enableHACAutoRedemption: false,
    enableOptimizelyNthOrderPromo: false,
    vShoppeConfiguration: { enableQnAOnPDP: false },
    mobileEnhancementMyAccountNavbar: true,
    optimizelyNthOrderPromoVariationOfferIdMap: {
      'Promo group 1': 'testOfferId1',
      'Promo group 2': 'testOfferId2',
    },
    signInViaGoogleJSLibraryPath: 'https://accounts.google.com/gsi/client',
    pdpUrl: '//content.vitaminshoppe.com/pdp',
    enablePlpFilterAppliedUpgrade: true,
    estimatedShippingMessage: 'within 48 hours',
    cartPageUrl: '/cart/shopping-cart',
    estimatedShipMsgPDP:
      '<strong><span class="ship-to-home-free">FREE </span><span>Same-Day Shipping</span></strong><span>, if ordered by 5 PM ET.</span>',
    enableLazyBrightcove: true,
    enableOGaMSIFeature: true,
    listOfUrlsToGenerateToken: [
      '/rest/model/core/rest/navigation/actor/VSINavigationActor/userSummary',
      '/s/checkout/checkout.jsp',
      '/rest/model/core/rest/navigation/actor/VSINavigationActor/globalContentConfig',
      '/rest/model/vitaminshoppe/web/actor/VSIWebShoppingCartActor/summary',
      '/rest/model/core/rest/gifts/actor/VSIGiftListActor/wishlistSkuIdentifier',
      '/rest/model/core/rest/navigation/actor/VSINavigationActor/seoSummary',
      '/rest/model/core/rest/customer/actor/VSICustomerActor/getUserInfoForDataLayer',
      '/rest/model/atg/commerce/order/purchase/CartModifierActor/addItemToOrder',
      '/rest/model/vitaminshoppe/web/actor/VSIWebShoppingCartActor/addItemToOrder',
    ],
    enableHACAutoRedemptionForADP: true,
    showHolidayGiftGuideTopNavLink: false,
    enableVshoppeTooltipUpgrade: true,
    enableUpgradeMyAccountQuickReorder: true,
    enableReorderOptInToggle: true,
    brandsRestrictedForADPDiscount: [],
    enableBoldChatUpgrade: false,
    turnToUrl: '//static.www.turnto.com/traServer4_3/trajs/',
    healthyAwardsLandingPageUrl:
      'https://www.vitaminshoppe.com/lp/Newhealthyawards',
    enableDeletedUserForciblyLogoutFeature: false,
    enablePlpFixedFilterBarUpgrade: true,
    enableLoyaltyFeature: true,
    aurusConnectivityCheckURL: '/storeservices/jsplugins/aurusonline.js',
    enableCrowdtwistOnLoyaltyPage: false,
    enableMultipleHAVouchers: true,
    displayProductCountOnPLP: false,
    enableDomNodeReductionToggle: true,
    enableATCInterceptForOOS: false,
    enableTopNavNameVariantForDigestion: 'false',
    hideHAPointsInPurchaseHistory: true,
    showVariantPromoFlags: false,
    enableAmpMSIFeature: false,
    pdpRichRelevenceUrl:
      'https://recs.richrelevance.com/rrserver/api/rrPlatform/recsForPlacements?apiClientKey=44d6b2d4d6b41f5d&apiKey=3d1793d5639baeb9&placements=',
    enableImpulseUpsellADPFreqDropdownFix: true,
    disableTS: false,
    enableUpgradeCustomSkinnyBanner: false,
    googlePayMerchantId: 'BCR2DN6TV7Q7B4CQ',
    enableGooglePayFeature: true,
  };
  if (
  ...
  // EDQ.JQuery.ajax({
  //   url: protocol + "//" + host + "/rest/model/core/rest/navigation/actor/VSINavigationActor/getEnvConfiguration",
